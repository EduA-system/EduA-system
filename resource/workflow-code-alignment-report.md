...
| 7   | Edit Weekly Task                       | Moderator          | Moderator sửa một weekly task cụ thể.                                                      | Code sửa theo cụm/bulk task, không hoàn toàn là sửa từng task độc lập.                                                                                                                                          | Làm rõ trong Workflow là sửa theo cụm task tuần, hoặc tách riêng nếu BA thật sự muốn sửa từng task.                                                                 |
