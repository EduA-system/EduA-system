...
public class LibraryContentController {
    ...
    @GetMapping("/moderation-queue/{id}") @PreAuthorize("hasRole('MODERATOR')") public LibraryViews.Detail moderationDetail(@PathVariable UUID id) { return service.getModerationDetail(id); }
