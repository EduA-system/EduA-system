...
@RestController
@RequestMapping("/api/it-management/system-prompts")
@PreAuthorize("hasRole('IT_MANAGEMENT')")
public class ItManagementController {
    private final AiSystemPromptService service;
    public ItManagementController(AiSystemPromptService service) { this.service = service; }
