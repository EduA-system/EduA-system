...
export const PLACEHOLDER_IMAGE =
  "data:image/svg+xml," +
  encodeURIComponent(
    '<svg xmlns="http://www.w3.org/2000/svg" width="320" height="240"><rect width="100%" height="100%" fill="#f5f1ec"/><text x="50%" y="50%" dominant-baseline="middle" text-anchor="middle" fill="#6b625a" font-size="14" font-family="Inter, sans-serif">Ảnh minh hoạ</text></svg>',
  );
