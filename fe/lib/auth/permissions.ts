...
export const routePermissions: Record<string, RoutePermission> = {
  ...
  "/mo-phong-vat-ly": { requireAuth: true, allowedRoles: ["TEACHER", "MODERATOR", "PRINCIPAL", "STUDENT"], allowedSubjects: ["PHYSICS"] },
  "/periodic-table":  { requireAuth: true, allowedRoles: ["TEACHER", "MODERATOR", "PRINCIPAL", "STUDENT"], allowedSubjects: ["CHEMISTRY"] },
