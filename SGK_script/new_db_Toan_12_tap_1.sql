...
('TOAN12_T1', 'Toán 12, tập một', 12, 'PDF', 'Giáo dục Việt Nam', 'Kết nối tri thức với cuộc sống') ON CONFLICT DO NOTHING;

INSERT INTO chapters (textbook_id, code, name, sort_order) VALUES ((SELECT id FROM textbooks WHERE code = 'TOAN12_T1'), 'CH0', 'CHƯƠNG MỞ ĐẦU', 0) ON CONFLICT DO NOTHING;

INSERT INTO chapters (textbook_id, code, name, sort_order) VALUES ((SELECT id FROM textbooks WHERE code = 'TOAN12_T1'), 'CH1', 'CHƯƠNG I. ỨNG DỤNG ĐẠO HÀM', 1) ON CONFLICT DO NOTHING;

INSERT INTO chapters (textbook_id, code, name, sort_order) VALUES ((SELECT id FROM textbooks WHERE code = 'TOAN12_T1'), 'CH2', 'CHƯƠNG II. VECTƠ TRONG KHÔNG GIAN', 2) ON CONFLICT DO NOTHING;

INSERT INTO chapters (textbook_id, code, name, sort_order) VALUES ((SELECT id FROM textbooks WHERE code = 'TOAN12_T1'), 'CH3', 'CHƯƠNG III. CÁC SỐ ĐẶC TRƯNG ĐO MỨC ĐỘ PHÂN TÁN CỦA MẪU SỐ LIỆU GHÉP NHÓM', 3) ON CONFLICT DO NOTHING;

INSERT INTO chapters (textbook_id, code, name, sort_order) VALUES ((SELECT id FROM textbooks WHERE code = 'TOAN12_T1'), 'CH4', 'HOẠT ĐỘNG THỰC HÀNH TRẢI NGHIỆM', 4) ON CONFLICT DO NOTHING;

INSERT INTO chapters (textbook_id, code, name, sort_order) VALUES ((SELECT id FROM textbooks WHERE code = 'TOAN12_T1'), 'END', 'HỘI ĐỒNG THẨM ĐỊNH', 5) ON CONFLICT DO NOTHING;

INSERT INTO lessons (chapter_id, code, name, page, sort_order, knowledge_json) VALUES
((SELECT id FROM chapters WHERE code = 'CH1' AND textbook_id = (SELECT id FROM textbooks WHERE code = 'TOAN12_T1')), 'B1', 'Tính đơn điệu của hàm số', 5, 1, $JSON$
{
  "content": [
    "# CHƯƠNG I",
    ...
    "",
    "[Hình ảnh: Đồ thị hàm số minh hoạ các khoảng giảm, tăng và điểm cực đại, cực tiểu. Một đường cong có dạng hình sin dao động lên xuống.]",
    "",
    "# Bài 1",
    ...
    "| :--- | :--- |",
    "| • Bảng biến thiên<br>• Đồng biến<br>• Nghịch biến<br>• Cực đại<br>• Cực tiểu<br>• Cực trị | • Nhận biết tính đồng biến, nghịch biến của một hàm số trên một khoảng dựa vào dấu đạo hàm cấp một của nó.<br>• Thể hiện tính đồng biến, nghịch biến của hàm số trong bảng biến thiên.<br>• Nhận biết tính đơn điệu của hàm số thông qua bảng biến thiên hoặc thông qua hình ảnh hình học của đồ thị hàm số.<br>• Nhận biết điểm cực trị, giá trị cực trị của hàm số thông qua bảng biến thiên hoặc thông qua hình ảnh hình học của đồ thị hàm số. |",
    "",
    ...
    "",
    "[Hình ảnh: Hình 1.1. Trục số nằm ngang với gốc toạ độ $O$ và điểm $s(t)$.]",
    "",
    "5",
    ...
    "[Hình ảnh: Hình 1.2. Đồ thị parabol $y = x^2$ đi qua gốc toạ độ, bề lõm hướng lên trên.]",
    "",
    ...
    "[Hình ảnh: Hình 1.3a. Đồ thị hàm số đi lên biểu diễn hàm số đồng biến trên khoảng $(a; b)$. Hình 1.3b. Đồ thị hàm số đi xuống biểu diễn hàm số nghịch biến trên khoảng $(a; b)$.]",
    ...
    "[Hình ảnh: Hình 1.4. Đồ thị hàm số $y = |x|$ gồm hai tia tạo thành hình chữ V đỉnh tại gốc toạ độ.]",
    "",
    "**Luyện tập 1.** Hình 1.5 là đồ thị của hàm số $y = x^3 - 3x^2 + 2$. Hãy tìm các khoảng đồng biến, khoảng nghịch biến của hàm số.",
    "[Hình ảnh: Hình 1.5. Đồ thị hàm số bậc ba $y = x^3 - 3x^2 + 2$. Hàm số đồng biến trên $(-\\infty; 0)$ và $(2; +\\infty)$, nghịch biến trên $(0; 2)$.]",
    "",
    "6",
    ...
    "[Hình ảnh: Hình 1.6. Đồ thị hàm số. Hàm số nghịch biến trên $(-\\infty; -1)$, hằng số trên $[-1; 1]$, đồng biến trên $(1; +\\infty)$.]",
    ...
    "Ta có: $y' = \\frac{(2x - 2)(x - 1) - (x^2 - 2x + 5)}{(x - 1)^2} = \\frac{x^2 - 2x - 3}{(x - 1)^2}$; $y' = 0 \\Leftrightarrow x = -1 \\text{ hoặc } x = 3$.",
    ...
    "> [Hình ảnh: Một robot hoạt hình vẫy tay giải thích chú ý.]",
    "",
    "8",
    ...
    "> [Hình ảnh: Robot hoạt hình đang nói.]",
    "",
    ...
    "| $y'$ | $?$ | $0$ | $?$ |",
    "| $y$ | $-2 \\searrow$ | $? \\nearrow$ | $0$ |",
    "[Hình ảnh: Hình 1.7. Đồ thị hàm số bậc ba $y = x^3 + 3x^2 - 4$. Hàm số đạt cực đại tại $x = -2, y = 0$ và đạt cực tiểu tại $x = 0, y = -4$.]",
    "",
    ...
    "",
    "**Chú ý**",
    "- Nếu hàm số $y = f(x)$ đạt cực đại tại $x_0$ thì $x_0$ được gọi là *điểm cực đại* của hàm số $f(x)$. Khi đó, $f(x_0)$ được gọi là *giá trị cực đại* của hàm số $f(x)$ và kí hiệu là $f_{CĐ}$ hay $y_{CĐ}$. Điểm $M_0(x_0; f(x_0))$ được gọi là *điểm cực đại* của đồ thị hàm số.",
    ...
    "Hàm số đạt cực tiểu tại $x = 1$ và $y_{CT} = y(1) = 2$.",
    "[Hình ảnh: Hình 1.8. Đồ thị hàm số có hai điểm cực tiểu và một điểm cực đại.]",
    "",
    "**Luyện tập 4.** Hình 1.9 là đồ thị của hàm số $y = f(x)$. Hãy tìm các cực trị của hàm số.",
    "[Hình ảnh: Hình 1.9. Đồ thị hàm số đạt cực đại tại $x = -1, y = 5$ và đạt cực tiểu tại $x = 1, y = 1$.]",
    "",
    ...
    "> a) Nếu $f'(x) < 0$ với mọi $x \\in (a; x_0)$ và $f'(x) > 0$ với mọi $x \\in (x_0; b)$ thì $x_0$ là một điểm cực tiểu của hàm số $f(x)$.",
    "> b) Nếu $f'(x) > 0$ với mọi $x \\in (a; x_0)$ và $f'(x) < 0$ với mọi $x \\in (x_0; b)$ thì $x_0$ là một điểm cực đại của hàm số $f(x)$.",
    "",
    "10",
    ...
    "| :--- | :--- | :--- | :--- |",
    "| $f'(x)$ | | $-$ | | $+$ | |",
    "| $f(x)$ | | $\\searrow$ | $f(x_0)$ (Cực tiểu) | $\\nearrow$ |",
    "",
    "| $x$ | $a$ | $x_0$ | $b$ |",
    "| :--- | :--- | :--- | :--- |",
    "| $f'(x)$ | | $+$ | | $-$ | |",
    "| $f(x)$ | | $\\nearrow$ | $f(x_0)$ (Cực đại) | $\\searrow$ |",
    "",
    ...
    "| :--- | :--- | :--- | :--- | :--- |",
    "| $y'$ | $+$ | $0$ | $-$ | $0$ | $+$ |",
    "| $y$ | $-\\infty \\nearrow 34$ | | $\\searrow 30$ | | $\\nearrow +\\infty$ |",
    "",
    "Từ bảng biến thiên, ta có:",
    "Hàm số đạt cực đại tại $x = 1$ và $y_{CĐ} = y(1) = 34$.",
    ...
    "[Hình ảnh: Hình 1.10. Đồ thị hàm số $y = x^3$.]",
    "",
    "11",
    ...
    "| :--- | :--- | :--- | :--- | :--- | :--- |",
    "| $y'$ | $+$ | $0$ | $-$ | $\\|$ | $-$ | $0$ | $+$ |",
    "| $y$ | $-\\infty \\nearrow -4$ | | $\\searrow -\\infty$ | $\\|$ | $+\\infty \\searrow 8$ | | $\\nearrow +\\infty$ |",
    "",
    "Từ bảng biến thiên, ta có:",
    "Hàm số đạt cực đại tại $x = -1$ và $y_{CĐ} = y(-1) = -4$.",
    ...
    "[Hình ảnh: Hình 1.11. Đồ thị hàm số bậc ba đi qua gốc toạ độ, cực đại tại (0; 0), cực tiểu tại $(1; -0,5)$. Cắt trục hoành tại $(1,5; 0)$.",
    "Hình 1.12. Đồ thị hàm số có hai điểm cực tiểu tại $x = -2, x = 2$ và một điểm cực đại tại $x = 0, y = \\sqrt[3]{16} \\approx 2,5$.]",
    "",
    ...
    "[Hình ảnh: Hình 1.13. Đồ thị hàm số $y=f'(x)$ cắt trục hoành tại các điểm $x=2, x=4, x=6$.]",
...
INSERT INTO lessons (chapter_id, code, name, page, sort_order, knowledge_json) VALUES
((SELECT id FROM chapters WHERE code = 'CH1' AND textbook_id = (SELECT id FROM textbooks WHERE code = 'TOAN12_T1')), 'B2', 'Cực trị của hàm số', 15, 2, $JSON$
{
  "content": [
    "# Bài 2",
    ...
    "| THUẬT NGỮ | KIẾN THỨC, KĨ NĂNG |",
    "| :--- | :--- |",
    "| • Giá trị lớn nhất<br>• Giá trị nhỏ nhất | • Nhận biết giá trị lớn nhất, giá trị nhỏ nhất của hàm số trên một tập xác định cho trước.<br>• Xác định giá trị lớn nhất, giá trị nhỏ nhất của hàm số bằng đạo hàm trong những trường hợp đơn giản. |",
    "",
    "Từ một tấm bìa carton hình vuông có độ dài cạnh bằng 60 cm, người ta cắt bốn hình vuông bằng nhau ở bốn góc rồi gập thành một chiếc hộp có dạng hình hộp chữ nhật không nắp (H.1.14). Tính cạnh của các hình vuông bị cắt sao cho thể tích của chiếc hộp là lớn nhất.",
    "",
    "[Hình ảnh: Hình 1.14. Tấm bìa carton hình vuông cạnh 60 cm cắt 4 góc vuông cạnh $x$, gập lại thành hộp chữ nhật không nắp.]",
    "",
    "## 1. ĐỊNH NGHĨA",
    ...
    "[Hình ảnh: Hình 1.15. Đồ thị hàm số $y = x^2 - 2x$ trên $[0; 3]$. Giá trị nhỏ nhất là $-1$ tại $x=1$, giá trị lớn nhất là 3 tại $x=3$.]",
    "",
    ...
    "Ta có:",
    "- $f(x) = \\sqrt{1 - x^2} \\ge 0$; dấu bằng xảy ra khi $1 - x^2 = 0$, tức là khi $x = -1$ hoặc $x = 1$.",
    "Do đó $\\min_{[-1; 1]} f(x) = f(-1) = f(1) = 0$.",
    "- $f(x) = \\sqrt{1 - x^2} \\le 1$; dấu bằng xảy ra khi $1 - x^2 = 1$, tức là khi $x = 0$. Do đó $\\max_{[-1; 1]} f(x) = f(0) = 1$.",
    "",
    ...
    "Tính các giới hạn:",
    "$\\lim_{x \\to 0^+} y = \\lim_{x \\to 0^+} \\left(x - 2 + \\frac{1}{x}\\right) = +\\infty$; $\\lim_{x \\to +\\infty} y = \\lim_{x \\to +\\infty} \\left(x - 2 + \\frac{1}{x}\\right) = +\\infty$.",
    "",
    "16",
    ...
    "**Giải**",
    "Gọi $x$ (cm) là độ dài cạnh của các hình vuông nhỏ được cắt ở bốn góc của tấm bìa. Điều kiện: $0 < x < 30$. Khi cắt bỏ bốn hình vuông nhỏ có cạnh $x$ (cm) ở bốn góc và gập lên thì ta được một chiếc hộp chữ nhật không nắp, có đáy là hình vuông với độ dài cạnh bằng $(60 - 2x)$ (cm) và chiều cao bằng $x$ (cm). Thể tích của chiếc hộp này là",
    "$V(x) = (60 - 2x)^2 \\cdot x = 4x^3 - 240x^2 + 3600x$ ($\\text{cm}^3$).",
    "Ta có: $V'(x) = 12x^2 - 480x + 3600$; $V'(x) = 0 \\Leftrightarrow x^2 - 40x + 300 = 0 \\Leftrightarrow x = 10$ (thoả mãn điều kiện) hoặc $x = 30$ (loại).",
    "Lập bảng biến thiên:",
    "| $x$ | $0$ | $10$ | $30$ |",
    "| :--- | :--- | :--- | :--- |",
    "| $V'(x)$ | | $+$ | $0$ | $-$ |",
    "| $V(x)$ | $0 \\nearrow 16000 \\searrow 0$ |",
    "",
    ...
    "[Hình ảnh: Hình 1.16. Đồ thị hàm số $y = x^3 - 2x^2 + 1$ trên $[-1; 2]$.]",
    "",
    "17",
    ...
    "",
    "**Vận dụng.** Giả sử sự lây lan của một loại virus ở một địa phương có thể được mô hình hoá bằng hàm số $N(t) = -t^3 + 12t^2, 0 \\le t \\le 12$, trong đó $N$ là số người bị nhiễm bệnh (tính bằng trăm người) và $t$ là thời gian (tuần).",
    ...
    "",
    "**1.14.** Một nhà sản xuất muốn thiết kế một chiếc hộp có dạng hình hộp chữ nhật không nắp, có đáy là hình vuông và diện tích bề mặt bằng $108\\text{ cm}^2$ như Hình 1.17. Tìm các kích thước của chiếc hộp sao cho thể tích của hộp là lớn nhất.",
    "[Hình ảnh: Hình 1.17. Hình hộp chữ nhật không nắp đáy vuông cạnh $x$, chiều cao $h$.]",
    "",
    "**1.15.** Một nhà sản xuất cần làm ra những chiếc bình có dạng hình trụ với dung tích $1\\text{ 000 cm}^3$. Mặt trên và mặt dưới của bình được làm bằng vật liệu có giá 1,2 nghìn đồng/$\\text{cm}^2$, trong khi mặt bên của bình được làm bằng vật liệu có giá 0,75 nghìn đồng/$\\text{cm}^2$. Tìm các kích thước của bình để chi phí vật liệu sản xuất mỗi chiếc bình là nhỏ nhất.",
    "",
    "19"
  ]
}
...
INSERT INTO lessons (chapter_id, code, name, page, sort_order, knowledge_json) VALUES
((SELECT id FROM chapters WHERE code = 'CH1' AND textbook_id = (SELECT id FROM textbooks WHERE code = 'TOAN12_T1')), 'B3', 'Đồ thị và tiệm cận', 20, 3, $JSON$
{
  "content": [
    "# Bài 3",
    ...
    "| THUẬT NGỮ | KIẾN THỨC, KĨ NĂNG |",
    "| :--- | :--- |",
    "| • Tiệm cận ngang<br>• Tiệm cận đứng<br>• Tiệm cận xiên | Nhận biết hình ảnh hình học của đường tiệm cận ngang, đường tiệm cận đứng, đường tiệm cận xiên của đồ thị hàm số. |",
    "",
    ...
    "[Hình ảnh: Hình 1.18. Đồ thị hàm số $m(t)$ giảm dần và tiến sát trục hoành khi $t \\to +\\infty$.]",
    "",
    ...
    "[Hình ảnh: Hình 1.19. Điểm $M$ trên đồ thị tiến sát đường thẳng $y=2$ khi $x \\to +\\infty$.]",
    "",
    ...
    "",
    "[Hình ảnh: Hình 1.20. Hai trường hợp đồ thị hàm số tiệm cận đường thẳng $y = y_0$ khi $x \\to +\\infty$ và khi $x \\to -\\infty$.]",
    ...
    "[Hình ảnh: Hình 1.21. Đồ thị hàm số có hai đường tiệm cận ngang $y=1$ và $y=-1$.]",
    "",
    ...
    "[Hình ảnh: Hình 1.22. Điểm $M$ tiến sát đường thẳng $x=1$ khi $x \\to 1^+$.]",
    "",
    ...
    "",
    "21",
    "[Hình ảnh: Hình 1.23. Bốn trường hợp đồ thị hàm số tiệm cận đường thẳng $x = x_0$ khi $x \\to x_0^+$ hoặc $x \\to x_0^-$.]",
    "a) và c). Đường thẳng $x = x_0$ là tiệm cận đứng của đồ thị (khi $x \\to x_0^+$).",
    "b) và d). Đường thẳng $x = x_0$ là tiệm cận đứng của đồ thị (khi $x \\to x_0^-$).",
    "",
    "**Ví dụ 3.** Tìm tiệm cận đứng của đồ thị hàm số $y = f(x) = \\frac{3 - x}{x + 2}$.",
    "**Giải**",
    "Ta có: $\\lim_{x \\to -2^+} f(x) = \\lim_{x \\to -2^+} \\frac{3 - x}{x + 2} = +\\infty$. Tương tự, $\\lim_{x \\to -2^-} f(x) = -\\infty$. Vậy đồ thị hàm số $f(x)$ có tiệm cận đứng là đường thẳng $x = -2$.",
    "",
    "**Ví dụ 4.** Tìm tiệm cận đứng của đồ thị hàm số $y = f(x) = \\frac{x^2 + 2}{x}$.",
    "**Giải**",
    "Ta có: $\\lim_{x \\to 0^+} f(x) = \\lim_{x \\to 0^+} \\frac{x^2 + 2}{x} = +\\infty$. Tương tự, $\\lim_{x \\to 0^-} f(x) = -\\infty$. Vậy đồ thị hàm số $f(x)$ có tiệm cận đứng là đường thẳng $x = 0$.",
    "",
    ...
    "$C(p) = \\frac{45p}{100 - p}$ (triệu đồng), với $0 \\le p < 100$.",
    ...
    "[Hình ảnh: Hình 1.24. Điểm $M$ trên đồ thị $(C)$ tiến sát đường thẳng $y = x - 1$ khi $x \\to +\\infty$.]",
    "",
    ...
    "",
    "[Hình ảnh: Hình 1.25. Đồ thị hàm số tiệm cận đường thẳng $y = ax + b$ khi $x \\to +\\infty$ và khi $x \\to -\\infty$.]",
    "Đường thẳng $y = ax + b$ là tiệm cận xiên của đồ thị (khi $x \\to +\\infty$).",
    "Đường thẳng $y = ax + b$ là tiệm cận xiên của đồ thị (khi $x \\to -\\infty$).",
    "",
    "**Ví dụ 5.** Cho hàm số $y = f(x) = x + \\frac{1}{x + 2}$. Tìm tiệm cận xiên của đồ thị hàm số $f(x)$.",
    "[Hình ảnh: Một học sinh nữ vẫy tay nói: $\\lim_{x \\to +\\infty} \\frac{1}{x} = \\lim_{x \\to -\\infty} \\frac{1}{x} = 0$.]",
    "**Giải**",
    "Ta có: $\\lim_{x \\to +\\infty} [f(x) - x] = \\lim_{x \\to +\\infty} \\frac{1}{x + 2} = 0$. Tương tự, $\\lim_{x \\to -\\infty} [f(x) - x] = 0$.",
    ...
    "[Hình ảnh: Hình 1.26. Đồ thị hàm số $y = \\frac{2x^2}{x^2-1}$ có tiệm cận ngang $y=2$ và hai tiệm cận đứng $x=1, x=-1$.]",
    "",
    ...
    "",
    "**1.20.** Một mảnh vườn hình chữ nhật có diện tích bằng $144\\text{ m}^2$. Biết độ dài một cạnh của mảnh vườn là $x$ (m).",
...
INSERT INTO lessons (chapter_id, code, name, page, sort_order, knowledge_json) VALUES
((SELECT id FROM chapters WHERE code = 'CH1' AND textbook_id = (SELECT id FROM textbooks WHERE code = 'TOAN12_T1')), 'B4', 'Khảo sát và vẽ đồ thị hàm số', 26, 4, $JSON$
{
  "content": [
    "# Bài 4",
    ...
    "| THUẬT NGỮ | KIẾN THỨC, KĨ NĂNG |",
    "| :--- | :--- |",
    "| • Chiều biến thiên<br>• Bảng biến thiên<br>• Cực trị<br>• Tiệm cận<br>• Đồ thị<br>• Tâm đối xứng<br>• Trục đối xứng | • Mô tả sơ đồ tổng quát để khảo sát hàm số (tìm tập xác định, xét chiều biến thiên, tìm cực trị, tìm tiệm cận, lập bảng biến thiên, vẽ đồ thị).<br>• Khảo sát tập xác định, chiều biến thiên, cực trị, tiệm cận, bảng biến thiên và vẽ đồ thị của các hàm số: hàm bậc ba, hàm phân thức hữu tỉ đơn giản.<br>• Nhận biết tính đối xứng (trục đối xứng, tâm đối xứng) của đồ thị các hàm số trên. |",
    "",
    ...
    "[Hình ảnh: Hình 1.27. Đồ thị hàm số $f(x) = \\frac{C(x)}{x}$ tiệm cận đường thẳng $y=2$.]",
    "",
    ...
    "- Hàm số đạt cực tiểu tại $x = 0$, giá trị cực tiểu $y_{CT} = -4$. Hàm số đạt cực đại tại $x = 2$, giá trị cực đại $y_{CĐ} = 0$.",
    "- Giới hạn tại vô cực: $\\lim_{x \\to -\\infty} y = \\lim_{x \\to -\\infty} x^3 \\left(-1 + \\frac{3}{x} - \\frac{4}{x^3}\\right) = +\\infty$; $\\lim_{x \\to +\\infty} y = \\lim_{x \\to +\\infty} x^3 \\left(-1 + \\frac{3}{x} - \\frac{4}{x^3}\\right) = -\\infty$.",
    "- Bảng biến thiên:",
    "| $x$ | $-\\infty$ | $0$ | $2$ | $+\\infty$ |",
    "| :--- | :--- | :--- | :--- | :--- |",
    "| $y'$ | $-$ | $0$ | $+$ | $0$ | $-$ |",
    ...
    "[Hình ảnh: Hình 1.28. Đồ thị hàm số $y = -x^3 + 3x^2 - 4$.]",
    "",
    ...
    "- Giới hạn tại vô cực: $\\lim_{x \\to -\\infty} y = \\lim_{x \\to -\\infty} x^3 \\left(1 - \\frac{2}{x} + \\frac{2}{x^2} - \\frac{1}{x^3}\\right) = -\\infty$; $\\lim_{x \\to +\\infty} y = \\lim_{x \\to +\\infty} x^3 \\left(1 - \\frac{2}{x} + \\frac{2}{x^2} - \\frac{1}{x^3}\\right) = +\\infty$.",
    "- Bảng biến thiên:",
    "| $x$ | $-\\infty$ | $+\\infty$ |",
    "| :--- | :--- | :--- |",
    "| $y'$ | $+$ |",
    ...
    "- Ta có $y = 0 \\Leftrightarrow x^3 - 2x^2 + 2x - 1 = 0 \\Leftrightarrow (x - 1)(x^2 - x + 1) = 0 \\Leftrightarrow x = 1$. Do đó giao điểm của đồ thị hàm số với trục hoành là điểm $(1; 0)$.",
    "- Đồ thị hàm số có tâm đối xứng là điểm $\\left(\\frac{2}{3}; -\\frac{7}{27}\\right)$.",
    "[Hình ảnh: Hình 1.29. Đồ thị hàm số $y = x^3 - 2x^2 + 2x - 1$.]",
    "",
    ...
    "- Hàm số không có cực trị.",
    "- Tiệm cận: $\\lim_{x \\to 2^-} y = \\lim_{x \\to 2^-} \\frac{x + 1}{x - 2} = -\\infty$; $\\lim_{x \\to 2^+} y = \\lim_{x \\to 2^+} \\frac{x + 1}{x - 2} = +\\infty$;",
    "$\\lim_{x \\to -\\infty} y = \\lim_{x \\to -\\infty} \\frac{x + 1}{x - 2} = 1$; $\\lim_{x \\to +\\infty} y = \\lim_{x \\to +\\infty} \\frac{x + 1}{x - 2} = 1$.",
    ...
    "[Hình ảnh: Hình 1.30. Đồ thị hàm số $y = \\frac{x+1}{x-2}$.]",
    "",
    ...
    "",
    "**Luyện tập 2.** Giải bài toán ở *tình huống mở đầu*, coi $f(x)$ là hàm số xác định với $x \\ge 1$.",
    "",
    ...
    "- Ta có: $y' = 1 - \\frac{1}{(x - 2)^2} = \\frac{x^2 - 4x + 3}{(x - 2)^2}$. Vậy $y' = 0 \\Leftrightarrow \\frac{x^2 - 4x + 3}{(x - 2)^2} = 0 \\Leftrightarrow x = 1 \\text{ hoặc } x = 3$.",
    "- Trên các khoảng $(-\\infty; 1)$ and $(3; +\\infty)$, $y' > 0$ nên hàm số đồng biến trên từng khoảng này. Trên các khoảng $(1; 2)$ và $(2; 3)$, $y' < 0$ nên hàm số nghịch biến trên từng khoảng này.",
    "- Hàm số đạt cực đại tại $x = 1$ với $y_{CĐ} = 1$; hàm số đạt cực tiểu tại $x = 3$ với $y_{CT} = 5$.",
    "- Giới hạn tại vô cực: $\\lim_{x \\to -\\infty} y = \\lim_{x \\to -\\infty} \\frac{x^2 - x - 1}{x - 2} = \\lim_{x \\to -\\infty} \\frac{x - 1 - \\frac{1}{x}}{1 - \\frac{2}{x}} = -\\infty$; $\\lim_{x \\to +\\infty} y = \\lim_{x \\to +\\infty} \\frac{x^2 - x - 1}{x - 2} = \\lim_{x \\to +\\infty} \\frac{x - 1 - \\frac{1}{x}}{1 - \\frac{2}{x}} = +\\infty$.",
    "- Tiệm cận: $\\lim_{x \\to 2^-} y = \\lim_{x \\to 2^-} \\left(x + 1 + \\frac{1}{x - 2}\\right) = -\\infty$; $\\lim_{x \\to 2^+} y = \\lim_{x \\to 2^+} \\left(x + 1 + \\frac{1}{x - 2}\\right) = +\\infty$;",
    "$\\lim_{x \\to +\\infty} [y - (x + 1)] = \\lim_{x \\to +\\infty} \\frac{1}{x - 2} = 0$; $\\lim_{x \\to -\\infty} [y - (x + 1)] = \\lim_{x \\to -\\infty} \\frac{1}{x - 2} = 0$.",
    ...
    "3. Đồ thị (H.1.31):",
    "- Giao điểm của đồ thị hàm số với trục tung là điểm $\\left(0; \\frac{1}{2}\\right)$.",
    "[Hình ảnh: Hình 1.31. Đồ thị hàm số $y = \\frac{x^2 - x - 1}{x - 2}$.]",
    "",
    "30",
    "- Ta có $y = 0 \\Leftrightarrow \\frac{x^2 - x - 1}{x - 2} = 0 \\Leftrightarrow x = \\frac{1 - \\sqrt{5}}{2}$ hoặc $x = \\frac{1 + \\sqrt{5}}{2}$. Do đó giao điểm của đồ thị hàm số với trục hoành là các điểm $\\left(\\frac{1 - \\sqrt{5}}{2}; 0\\right)$ và $\\left(\\frac{1 + \\sqrt{5}}{2}; 0\\right)$.",
    ...
    "- Hàm số không có cực trị.",
    "- Giới hạn tại vô cực: $\\lim_{x \\to -\\infty} y = \\lim_{x \\to -\\infty} \\frac{x^2 + x - 2}{x + 1} = \\lim_{x \\to -\\infty} \\frac{x + 1 - \\frac{2}{x}}{1 + \\frac{1}{x}} = -\\infty$; $\\lim_{x \\to +\\infty} y = \\lim_{x \\to +\\infty} \\frac{x^2 + x - 2}{x + 1} = \\lim_{x \\to +\\infty} \\frac{x + 1 - \\frac{2}{x}}{1 + \\frac{1}{x}} = +\\infty$.",
    "- Tiệm cận: $\\lim_{x \\to -1^-} y = \\lim_{x \\to -1^-} \\left(x - \\frac{2}{x + 1}\\right) = +\\infty$; $\\lim_{x \\to -1^+} y = \\lim_{x \\to -1^+} \\left(x - \\frac{2}{x + 1}\\right) = -\\infty$;",
    "$\\lim_{x \\to +\\infty} [y - x] = \\lim_{x \\to +\\infty} \\left(-\\frac{2}{x + 1}\\right) = 0$; $\\lim_{x \\to -\\infty} [y - x] = \\lim_{x \\to -\\infty} \\left(-\\frac{2}{x + 1}\\right) = 0$.",
    ...
    "- Ta có $y = 0 \\Leftrightarrow \\frac{x^2 + x - 2}{x + 1} = 0 \\Leftrightarrow x = -2$ hoặc $x = 1$. Do đó giao điểm của đồ thị hàm số với trục hoành là các điểm $(-2; 0)$ và $(1; 0)$.",
    "[Hình ảnh: Hình 1.32. Đồ thị hàm số $y = \\frac{x^2 + x - 2}{x + 1}$.]",
    "",
    "31",
    ...
    "",
    "**1.24.** Một cốc chứa $30\\text{ ml}$ dung dịch KOH (potassium hydroxide) với nồng độ $100\\text{ mg/ml}$. Một bình chứa dung dịch KOH khác với nồng độ $8\\text{ mg/ml}$ được trộn vào cốc.",
    ...
    "c) Giải thích tại sao nồng độ KOH trong cốc giảm theo $x$ nhưng luôn lớn hơn $8\\text{ mg/ml}$.",
    "",
    "**1.25.** Trong Vật lí, ta biết rằng khi mắc song song hai điện trở $R_1$ và $R_2$ thì điện trở tương đương $R$ của mạch điện được tính theo công thức $R = \\frac{R_1 R_2}{R_1 + R_2}$ (theo *Vật lí đại dương*, NXB Giáo dục Việt Nam, 2016).",
    "[Hình ảnh: Hình 1.33. Sơ đồ mạch điện mắc song song hai điện trở $8\\ \\Omega$ và $x$.]",
...
INSERT INTO lessons (chapter_id, code, name, page, sort_order, knowledge_json) VALUES
((SELECT id FROM chapters WHERE code = 'CH1' AND textbook_id = (SELECT id FROM textbooks WHERE code = 'TOAN12_T1')), 'B5', 'Tốc độ thay đổi của một đại lượng. Tối ưu hóa', 33, 5, $JSON$
{
  "content": [
    "# Bài 5",
    ...
    "| THUẬT NGỮ | KIẾN THỨC, KĨ NĂNG |",
    "| :--- | :--- |",
    "| • Tốc độ thay đổi tức thời<br>• Bài toán tối ưu hoá | Vận dụng đạo hàm và khảo sát hàm số để giải quyết một số vấn đề liên quan đến thực tiễn. |",
    "",
    ...
    "[Hình ảnh: Sân vận động bóng đá đông kín khán giả dưới ánh đèn.]",
    "",
    ...
    "- Nếu $s = s(t)$ là hàm vị trí của một vật chuyển động trên một đường thẳng thì $v = s'(t)$ biểu thị vận tốc tức thời của vật (tốc độ thay đổi của vị trí chuyển động theo thời gian). Tốc độ thay đổi tức thời của vận tốc theo thời gian là gia tốc tức thời của vật:",
    "$a(t) = v'(t) = s''(t)$.",
    ...
    "",
    "33",
    "- Nếu $C = C(x)$ là hàm chi phí, tức là tổng chi phí khi sản xuất $x$ đơn vị hàng hoá, thì tốc độ thay đổi tức thời $C'(x)$ của chi phí đối với số lượng đơn vị hàng hoá được sản xuất được gọi là *chi phí biên*.",
    ...
    "",
    "**Ví dụ 1.** Khi bỏ qua sức cản của không khí, độ cao (mét) của một vật được phóng thẳng đứng lên trên từ điểm cách mặt đất $2\\text{ m}$ với vận tốc ban đầu $24,5\\text{ m/s}$ là $h(t) = 2 + 24,5t - 4,9t^2$ (theo *Vật lí đại cương*, NXB Giáo dục Việt Nam, 2016).",
    ...
    "$t = -\\frac{b}{2a} = \\frac{24,5}{2 \\cdot 4,9} = 2,5$ (giây). Khi đó, độ cao lớn nhất của vật là $h(2,5) = 32,625$ (m).",
    ...
    "**Giải**",
    "Ta có: $P'(t) = \\frac{0,75 a e^{-0,75t}}{(b + e^{-0,75t})^2}, t \\ge 0$.",
    ...
    "",
    "34",
    "Khi đó, $P'(t) = \\frac{18,75e^{-0,75t}}{\\left(\\frac{1}{4} + e^{-0,75t}\\right)^2} > 0, \\forall t \\ge 0$, tức là số lượng quần thể nấm men luôn tăng.",
    "Tuy nhiên, do $\\lim_{t \\to +\\infty} P(t) = \\lim_{t \\to +\\infty} \\frac{25}{\\frac{1}{4} + e^{-0,75t}} = 100$ nên số lượng quần thể nấm men tăng nhưng không vượt quá 100 tế bào.",
    "",
    ...
    "$C(x) = \\frac{300x}{100 - x}$ (triệu đồng), $0 \\le x < 100$.",
    ...
    "Ta có:",
    "- $y' = \\frac{30\\ 000}{(100 - x)^2} > 0$, với mọi $x \\in [0; 100)$.",
    ...
    "b) Vì $\\lim_{x \\to 100^-} C(x) = +\\infty$ (hàm số $C(x)$ không xác định khi $x = 100$) nên nhà máy không thể loại bỏ 100% chất gây ô nhiễm không khí (dù bỏ ra chi phí là bao nhiêu đi chăng nữa).",
    "[Hình ảnh: Hình 1.34. Đồ thị hàm số chi phí loại bỏ chất gây ô nhiễm không khí.]",
    "",
    ...
    "$P(t) = \\frac{25t^2 + 125}{t^2 + 1}, 0 \\le t \\le 10$,",
    ...
    "Do thể tích của hình trụ là $1\\ 000\\text{ cm}^3$ nên ta có: $1\\ 000 = V = \\pi r^2 h$, hay $h = \\frac{1\\ 000}{\\pi r^2}$.",
    "Do đó, diện tích toàn phần của hình trụ là: $S = 2\\pi r^2 + \\frac{2\\ 000}{r}, r > 0$.",
    "Ta cần tìm $r$ sao cho $S$ đạt giá trị nhỏ nhất. Ta có:",
    "$S' = 4\\pi r - \\frac{2\\ 000}{r^2} = \\frac{4\\pi r^3 - 2\\ 000}{r^2}$; $S' = 0 \\Leftrightarrow \\pi r^3 = 500 \\Leftrightarrow r = \\sqrt[3]{\\frac{500}{\\pi}}$.",
    "Bảng biến thiên:",
    "| $r$ | $0$ | $\\sqrt[3]{\\frac{500}{\\pi}}$ | $+\\infty$ |",
    "| :--- | :--- | :--- | :--- |",
    "| $S'(r)$ | | $-$ | $0$ | $+$ |",
    "| $S(r)$ | $+\\infty \\searrow S\\left(\\sqrt[3]{\\frac{500}{\\pi}}\\right) \\nearrow +\\infty$ |",
    "",
    "Khi đó: $h = \\frac{1\\ 000}{\\pi r^2} = \\frac{1\\ 000}{\\pi \\sqrt[3]{\\left(\\frac{500}{\\pi}\\right)^2}} = \\frac{100}{\\sqrt[3]{250\\pi}}$.",
    ...
    "Do đó, phương trình đường thẳng $p = ax + b$ đi qua hai điểm $(27\\ 000; 100)$ và $(30\\ 000; 90)$ là $p - 100 = \\frac{100 - 90}{27\\ 000 - 30\\ 000}(x - 27\\ 000)$, hay $p - 100 = -\\frac{1}{300}(x - 27\\ 000)$,",
    ...
    "| :--- | :--- | :--- | :--- |",
    "| $R'(p)$ | | $+$ | $0$ | $-$ |",
    "| $R(p)$ | $0 \\nearrow 2\\ 707\\ 500 \\searrow -\\infty$ |",
    "",
    ...
    "$P(x) = -0,3x^3 + 36x^2 + 1\\ 800x - 48\\ 000$.",
    "Khảo sát sự biến thiên và vẽ đồ thị hàm số $y = P(x), x \\ge 0$. Sử dụng đồ thị đã vẽ để trả lời các câu hỏi sau:",
    ...
    "**Giải**",
    "Xét hàm số $y = P(x) = -0,3x^3 + 36x^2 + 1\\ 800x - 48\\ 000, x \\ge 0$.",
    "Ta có:",
    "- $y' = P'(x) = -0,9x^2 + 72x + 1\\ 800$; $y' = 0 \\Leftrightarrow x = 100$ (vì $x \\ge 0$).",
    ...
    "Tại $x = 100$, hàm số đạt cực đại và $y_{CĐ} = y(100) = 192\\ 000$.",
    "- $\\lim_{x \\to +\\infty} P(x) = -\\infty$.",
    "Bảng biến thiên:",
    "| $x$ | $0$ | $100$ | $+\\infty$ |",
    "| :--- | :--- | :--- | :--- |",
    "| $P'(x)$ | | $+$ | $0$ | $-$ |",
    "| $P(x)$ | $-48\\ 000 \\nearrow 192\\ 000 \\searrow -\\infty$ |",
    "",
    "39",
    ...
    "Lợi nhuận lớn nhất mà công ty có thể thu được là $y_{CĐ} = y(100) = 192\\ 000$ (nghìn đồng), tức là 192 triệu đồng, đạt được khi sản xuất đúng 100 chiếc máy xay sinh tố mỗi tháng.",
    "[Hình ảnh: Hình 1.36. Đồ thị hàm lợi nhuận $P(x)$ của công ty.]",
    "",
    ...
    "",
    "**1.29.** Giả sử hàm cầu đối với một loại hàng hoá được cho bởi công thức",
...
INSERT INTO lessons (chapter_id, code, name, page, sort_order, knowledge_json) VALUES
((SELECT id FROM chapters WHERE code = 'CH2' AND textbook_id = (SELECT id FROM textbooks WHERE code = 'TOAN12_T1')), 'B6', 'Vectơ trong không gian', 45, 1, $JSON$
{
  "content": [
    "# CHƯƠNG II",
    "# VECTƠ VÀ HỆ TRỤC TOẠ ĐỘ TRONG KHÔNG GIAN",
    "",
    ...
    "",
    "[Hình ảnh: Tờ tiền 200 Phờ-răng của Thuỵ Sĩ gợi lên hình ảnh về một hệ toạ độ trong không gian.]",
    "*Tờ tiền 200 Phờ-răng của Thuỵ Sĩ gợi lên hình ảnh về một hệ toạ độ trong không gian.*",
    "",
    "# Bài 6",
    ...
    "| THUẬT NGỮ | KIẾN THỨC, KĨ NĂNG |",
    "| :--- | :--- |",
    "| Vectơ trong không gian | • Nhận biết vectơ trong không gian.<br>• Nhận biết và thực hiện các phép toán vectơ trong không gian. |",
    "",
    ...
    "",
    "[Hình ảnh: Hình 2.1. Các mũi tên chỉ đường gợi lên hình ảnh về vectơ trong không gian.]",
    ...
    "[Hình ảnh: Hình 2.2. Kiện hàng treo bởi các sợi dây cáp từ cần cẩu.]",
    "",
    "> - **Vectơ trong không gian** là một đoạn thẳng có hướng.",
    "> - Độ dài của vectơ trong không gian là khoảng cách giữa điểm đầu và điểm cuối của vectơ đó.",
    "",
    "[Hình ảnh: Robot hoạt hình gợi ý hỏi:]",
    ...
    "[Hình ảnh: Hình 2.3. Lá cờ đỏ sao vàng tung bay trước Lăng Bác và chiếc máy bay đang bay trên bầu trời với các mũi tên đỏ biểu diễn vectơ vận tốc gió và vận tốc máy bay.]",
    ...
    "[Hình ảnh: Hình 2.4. Đường thẳng $d$ là giá của vectơ $\\vec{a}$.]",
    "",
    "46",
    ...
    "[Hình ảnh: Hình 2.5. Tứ diện đều ABCD cạnh bằng 1 với các vectơ đỏ $\\vec{AB}, \\vec{AC}, \\vec{AD}$.]",
    "**Giải**",
    "a) Có ba vectơ là $\\vec{AB}, \\vec{AC}$ và $\\vec{AD}$.",
    "b) Trong ba vectơ $\\vec{AB}, \\vec{AC}$ và $\\vec{AD}$ chỉ có hai vectơ $\\vec{AB}$ và $\\vec{AC}$ có giá nằm trong mặt phẳng $(ABC)$.",
    "c) Vì tứ diện $ABCD$ có độ dài mỗi cạnh bằng 1 nên $|\\vec{AB}| = |\\vec{AC}| = |\\vec{AD}| = 1$.",
    "",
    "**Luyện tập 1.** Cho hình lập phương $ABCD.A'B'C'D'$ (H.2.6).",
    "Trong các vectơ $\\vec{AC}, \\vec{AD}, \\vec{AD'}$:",
    "a) Hai vectơ nào có giá cùng nằm trong mặt phẳng $(ABCD)$?",
    "b) Hai vectơ nào có cùng độ dài?",
    "[Hình ảnh: Hình 2.6. Hình lập phương $ABCD.A'B'C'D'$ có các vectơ xanh lá $\\vec{AC}, \\vec{AD}, \\vec{AD'}$.]",
    "",
    ...
    "a) So sánh độ dài của hai vectơ $\\vec{AB}$ và $\\vec{D'C'}$.",
    "b) Nhận xét về giá của hai vectơ $\\vec{AB}$ và $\\vec{D'C'}$.",
    "c) Hai vectơ $\\vec{AB}$ và $\\vec{D'C'}$ có cùng phương không? Có cùng hướng không?",
    "[Hình ảnh: Hình 2.7. Hình hộp $ABCD.A'B'C'D'$ có hai vectơ xanh $\\vec{AB}$ và $\\vec{D'C'}$.]",
    "",
    ...
    "- Trong không gian, với mỗi điểm O và vectơ $\\vec{a}$ cho trước, có duy nhất điểm $M$ sao cho $\\vec{OM} = \\vec{a}$.",
    "",
    "47",
    "- Các vectơ có điểm đầu và điểm cuối trùng nhau, ví dụ như $\\vec{AA}, \\vec{BB}, ...$ gọi là các vectơ-không.",
    ...
    "a) Trong ba vectơ $\\vec{BC}, \\vec{CC'}$ và $\\vec{B'B}$, vectơ nào bằng vectơ $\\vec{AA'}$? Giải thích vì sao.",
    "b) Gọi $M$ là trung điểm của cạnh $BC$. Xác định điểm $M'$ sao cho $\\vec{MM'} = \\vec{AA'}$.",
    "[Hình ảnh: Hình 2.8. Hình lăng trụ đứng tam giác $ABC.A'B'C'$. Điểm M trên BC và điểm M' trên B'C'.]",
    "**Giải**",
    "a) Hai đường thẳng $AA'$ và $BC$ chéo nhau nên hai vectơ $\\vec{AA'}$ và $\\vec{BC}$ không cùng phương. Do đó, hai vectơ $\\vec{AA'}$ và $\\vec{BC}$ không bằng nhau.",
    "Tứ giác $ACC'A'$ là hình bình hành nên $AA' // CC'$ và $AA' = CC'$. Hai vectơ $\\vec{AA'}$ và $\\vec{CC'}$ có cùng độ dài và cùng hướng nên hai vectơ đó bằng nhau.",
    "Tương tự, hai vectơ $\\vec{AA'}$ và $\\vec{B'B}$ có cùng độ dài và ngược hướng nên hai vectơ $\\vec{AA'}$ và $\\vec{B'B}$ không bằng nhau.",
    "b) Gọi $M'$ là trung điểm của cạnh $B'C'$. Vì tứ giác $BCC'B'$ là hình bình hành nên $MM' // BB'$ và $MM' = BB'$. Hình lăng trụ $ABC.A'B'C'$ có $AA' // BB'$ và $AA' = BB'$, suy ra $MM' // AA'$ và $MM' = AA'$. Hai vectơ $\\vec{MM'}$ và $\\vec{AA'}$ có cùng độ dài và cùng hướng nên $\\vec{MM'} = \\vec{AA'}$. Vậy trung điểm của cạnh $B'C'$ là điểm $M'$ cần tìm.",
    "",
    "**Luyện tập 2.** Cho hình chóp $S.ABCD$ có đáy $ABCD$ là hình bình hành.",
    "a) Trong ba vectơ $\\vec{SC}, \\vec{AD}$ và $\\vec{DC}$, vectơ nào bằng vectơ $\\vec{AB}$?",
    "b) Gọi $M$ là một điểm thuộc cạnh $AD$. Xác định điểm $N$ sao cho $\\vec{MN} = \\vec{AB}$.",
    "",
    "**Vận dụng 1.** Một toà nhà có chiều cao của các tầng là như nhau. Một chiếc thang máy di chuyển từ tầng 15 lên tầng 22, sau đó di chuyển từ tầng 22 lên tầng 29. Các vectơ biểu diễn độ dịch chuyển của thang máy trong hai lần di chuyển đó có bằng nhau không? Giải thích vì sao.",
    "[Hình ảnh: Hình 2.9. Thang máy kính di chuyển bên trong giếng trời của toà nhà.]",
    "",
    "48",
    ...
    "Trong không gian, cho hai vectơ $\\vec{a}$ và $\\vec{b}$ không cùng phương. Lấy điểm $A$ và vẽ các vectơ $\\vec{AB} = \\vec{a}$, $\\vec{BC'} = \\vec{b}$. Lấy điểm $A'$ khác $A$ và vẽ các vectơ $\\vec{A'B'} = \\vec{a}$, $\\vec{B'C'} = \\vec{b}$ (H.2.10).",
    "a) Giải thích vì sao $\\vec{AA'} = \\vec{BB'}$ và $\\vec{BB'} = \\vec{CC'}$.",
    "b) Giải thích vì sao $AA'C'C$ là hình bình hành, từ đó suy ra $\\vec{AC} = \\vec{A'C'}$.",
    "[Hình ảnh: Hình 2.10. Minh hoạ phép cộng hai vectơ $\\vec{a}$ và $\\vec{b}$ bằng cách tịnh tiến.]",
    "*Bốn điểm $A$, $B$, $A'$, $B'$ đồng phẳng và tứ giác $ABB'A'$ là hình bình hành.*",
    "",
    "> Trong không gian, cho hai vectơ $\\vec{a}$ và $\\vec{b}$. Lấy một điểm $A$ bất kì và các điểm $B, C$ sao cho $\\vec{AB} = \\vec{a}$, $\\vec{BC} = \\vec{b}$. Khi đó, vectơ $\\vec{AC}$ được gọi là **tổng của hai vectơ** $\\vec{a}$ và $\\vec{b}$, kí hiệu là $\\vec{a} + \\vec{b}$.",
    "> Trong không gian, phép lấy tổng của hai vectơ được gọi là **phép cộng vectơ**.",
    "[Hình ảnh: Hình 2.11. Biểu diễn tổng $\\vec{a} + \\vec{b}$ bằng quy tắc tam giác.]",
    "",
    "**Nhận xét.** Quy tắc ba điểm và quy tắc hình bình hành trong mặt phẳng vẫn đúng trong không gian:",
    "- Nếu $A, B, C$ là ba điểm bất kì thì $\\vec{AB} + \\vec{BC} = \\vec{AC}$;",
    "- Nếu $ABCD$ là hình bình hành thì $\\vec{AB} + \\vec{AD} = \\vec{AC}$.",
    "",
    "**Ví dụ 3.** Cho hình lập phương $ABCD.A'B'C'D'$ có độ dài mỗi cạnh bằng 1 (H.2.12). Tính độ dài của vectơ $\\vec{BC} + \\vec{DD'}$.",
    "**Giải**",
    "Tứ giác $ABCD$ là hình vuông nên $\\vec{BC} = \\vec{AD}$.",
    "Do đó $\\vec{BC} + \\vec{DD'} = \\vec{AD} + \\vec{DD'} = \\vec{AD'}$.",
    "Tứ giác $ADD'A'$ là hình vuông nên $AD' = \\sqrt{AD^2 + DD'^2} = \\sqrt{2}$, suy ra $|\\vec{BC} + \\vec{DD'}| = \\sqrt{2}$.",
    "[Hình ảnh: Hình 2.12. Hình lập phương $ABCD.A'B'C'D'$.]",
    "",
    "49",
    "**Luyện tập 3.** Trong Ví dụ 3, hãy tính độ dài của vectơ $\\vec{AC} + \\vec{C'D'}$.",
    "",
    ...
    "",
    "**Ví dụ 4.** Cho tứ diện $ABCD$ (H.2.13). Chứng minh rằng $\\vec{AC} + \\vec{BD} = \\vec{AD} + \\vec{BC}$.",
    "[Hình ảnh: Hình 2.13. Tứ diện ABCD.]",
    "**Giải**",
    "Theo quy tắc ba điểm trong không gian, ta có $\\vec{AC} = \\vec{AD} + \\vec{DC}$.",
    "Từ đó lần lượt áp dụng tính chất của phép cộng vectơ trong không gian, ta được:",
    "$\\vec{AC} + \\vec{BD} = (\\vec{AD} + \\vec{DC}) + \\vec{BD} = \\vec{AD} + (\\vec{DC} + \\vec{BD}) = \\vec{AD} + (\\vec{BD} + \\vec{DC}) = \\vec{AD} + \\vec{BC}$.",
    "",
    "**Luyện tập 4.** Cho tứ diện $ABCD$ (H.2.13). Chứng minh rằng $\\vec{AB} + \\vec{CD} = \\vec{AD} + \\vec{CB}$.",
    "",
    "**HĐ4.** Thiết lập quy tắc hình hộp",
    "Cho hình hộp $ABCD.A'B'C'D'$ (H.2.14).",
    "[Hình ảnh: Hình 2.14. Hình hộp $ABCD.A'B'C'D'$ có các vectơ xanh lá $\\vec{AB}, \\vec{AD}, \\vec{AA'}, \\vec{AC'}$.]",
    "a) Hai vectơ $\\vec{AB} + \\vec{AD}$ và $\\vec{AC}$ có bằng nhau hay không?",
    "b) Hai vectơ $\\vec{AB} + \\vec{AD} + \\vec{AA'}$ và $\\vec{AC'}$ có bằng nhau hay không?",
    "",
    "Kết quả sau đây được gọi là **quy tắc hình hộp**:",
    "> Cho hình hộp $ABCD.A'B'C'D'$. Khi đó, ta có $\\vec{AB} + \\vec{AD} + \\vec{AA'} = \\vec{AC'}$.",
    "",
    "[Hình ảnh: Robot hoạt hình hỏi:]",
    "Trong Hình 2.14, hãy phát biểu quy tắc hình hộp với các vectơ có điểm đầu là $B$.",
    "",
    "**Ví dụ 5.** Cho hình hộp $ABCD.A'B'C'D'$ (H.2.14). Chứng minh rằng $\\vec{BC} + \\vec{DC} + \\vec{AA'} = \\vec{AC'}$.",
    "**Giải**",
    "Vì tứ giác $ABCD$ là hình bình hành nên $\\vec{BC} = \\vec{AD}$ và $\\vec{DC} = \\vec{AB}$. Áp dụng quy tắc hình hộp suy ra $\\vec{BC} + \\vec{DC} + \\vec{AA'} = \\vec{AD} + \\vec{AB} + \\vec{AA'} = \\vec{AC'}$.",
    "",
    "**Luyện tập 5.** Cho hình hộp chữ nhật $ABCD.A'B'C'D'$. Chứng minh rằng $\\vec{BB'} + \\vec{CD} + \\vec{AD} = \\vec{BD'}$.",
    "",
    "50"
  ]
}
...
INSERT INTO lessons (chapter_id, code, name, page, sort_order, knowledge_json) VALUES
((SELECT id FROM chapters WHERE code = 'CH2' AND textbook_id = (SELECT id FROM textbooks WHERE code = 'TOAN12_T1')), 'B7', 'Tổng và hiệu của hai vectơ trong không gian', 51, 2, $JSON$
{
  "content": [
    ...
    "[Hình ảnh: Hình 2.15. Lọ hoa màu hồng trên bàn và hai vectơ lực ngược chiều nhau.]",
    ...
    "- Vectơ $\\vec{BA}$ là một vectơ đối của vectơ $\\vec{AB}$.",
    ...
    "",
    "**Nhận xét.** Với ba điểm $O, A, B$ bất kì trong không gian, ta có $\\vec{OB} - \\vec{OA} = \\vec{AB}$.",
    "",
    "**Ví dụ 6.** Cho hình chóp $S.ABCD$ có đáy $ABCD$ là hình bình hành. Gọi $M, N$ lần lượt là trung điểm của $AB, CD$ (H.2.16).",
    "Chứng minh rằng:",
    "a) $\\vec{AM}$ và $\\vec{CN}$ là hai vectơ đối nhau;",
    "b) $\\vec{SC} - \\vec{AM} - \\vec{AN} = \\vec{SA}$.",
    "[Hình ảnh: Hình 2.16. Hình chóp S.ABCD.]",
    "**Giải**",
    "a) Tứ giác $ABCD$ là hình bình hành nên $AB = CD$ và $AB // CD$, suy ra $AM = CN$ và $AM // CN$. Hai vectơ $\\vec{AM}$ và $\\vec{CN}$ có cùng độ dài và ngược hướng nên chúng là hai vectơ đối nhau.",
    "b) Từ câu a, ta có $\\vec{CN} = -\\vec{AM}$.",
    "Suy ra $\\vec{SC} - \\vec{AM} - \\vec{AN} = \\vec{SC} + \\vec{CN} - \\vec{AN} = \\vec{SN} - \\vec{AN} = \\vec{SN} + \\vec{NA} = \\vec{SA}$.",
    "",
    "51",
    "**Luyện tập 6.** Trong Ví dụ 6, chứng minh rằng:",
    "a) $\\vec{BN}$ và $\\vec{DM}$ là hai vectơ đối nhau;",
    "b) $\\vec{SD} - \\vec{BN} - \\vec{CM} = \\vec{SC}$.",
    "",
    ...
    "[Hình ảnh: Thang cuốn trong siêu thị với hai làn chạy ngược nhau.]",
    ...
    "",
    "## 3. TÍCH CỦA MỘT SỐ VỚI VỘT VECTƠ TRONG KHÔNG GIAN",
    ...
    "[Hình ảnh: Hình 2.17. Hình lăng trụ tam giác $ABC.A'B'C'$.]",
    "a) Hai vectơ $\\vec{MN}$ và $\\vec{B'C'}$ có cùng phương không? Có cùng hướng không?",
    "b) Giải thích vì sao $|\\vec{MN}| = \\frac{1}{2}|\\vec{B'C'}|$.",
    "",
    ...
    "[Hình ảnh: Hình 2.18. Hình lăng trụ tam giác $ABC.A'B'C'$ có điểm O là giao điểm của AB' và A'B.]",
    "**Giải**",
    "Vì O là trung điểm của $AB'$ nên $OM$ là đường trung bình của tam giác $AB'B$. Suy ra $B'B // OM$ và $B'B = 2OM$. Tứ giác $BCC'B'$ là hình bình hành nên $B'B // C'C$ và $B'B = C'C$.",
    "Do đó $C'C // OM$ và $C'C = 2OM$. Vì hai vectơ $\\vec{CC'}$ và $\\vec{OM}$ ngược hướng nên $\\vec{CC'} = (-2)\\vec{OM}$.",
    "",
    ...
    "",
    "**Ví dụ 8.** Cho tứ diện $ABCD$. Gọi G là trọng tâm của tam giác $BCD$ (H.2.19). Chứng minh rằng $\\vec{AB} + \\vec{AC} + \\vec{AD} = 3\\vec{AG}$.",
    "[Hình ảnh: Hình 2.19. Tứ diện ABCD có trọng tâm G của tam giác BCD.]",
    "**Giải**",
    "Vì G là trọng tâm của tam giác $BCD$ nên $\\vec{GB} + \\vec{GC} + \\vec{GD} = \\vec{0}$.",
    "Do đó ta có: $\\vec{AB} + \\vec{AC} + \\vec{AD} = \\vec{AG} + \\vec{GB} + \\vec{AG} + \\vec{GC} + \\vec{AG} + \\vec{GD} = 3\\vec{AG} + (\\vec{GB} + \\vec{GC} + \\vec{GD}) = 3\\vec{AG} + \\vec{0} = 3\\vec{AG}$.",
    "",
    ...
    "Trong không gian, cho hai vectơ $\\vec{a}, \\vec{b}$ khác $\\vec{0}$. Lấy điểm O và vẽ các vectơ $\\vec{OA} = \\vec{a}, \\vec{OB} = \\vec{b}$. Lấy điểm O' khác O và vẽ các vectơ $\\vec{O'A'} = \\vec{a}, \\vec{O'B'} = \\vec{b}$ (H.2.21).",
    "a) Giải thích vì sao $\\vec{AB} = \\vec{A'B'}$.",
    "b) Áp dụng định lí côsin cho hai tam giác $OAB$ và $O'A'B'$ để giải thích vì sao $\\widehat{AOB} = \\widehat{A'O'B'}$.",
    "[Hình ảnh: Hình 2.21. Góc giữa hai vectơ.]",
    "",
    "54",
    "[Hình ảnh: Hình 2.21. Góc giữa hai vectơ $\\vec{a}$ và $\\vec{b}$ được dựng bằng cách vẽ các vectơ có cùng gốc O.]",
    "*Hình 2.21*",
    "[Hình ảnh: Học sinh nam giải thích côsin góc AOB.]",
    "$\\cos \\widehat{AOB} = \\frac{OA^2 + OB^2 - AB^2}{2OA \\cdot OB}$.",
    "",
    "> Trong không gian, cho hai vectơ $\\vec{a}, \\vec{b}$ khác $\\vec{0}$. Lấy một điểm O bất kì và gọi $A, B$ là hai điểm sao cho $\\vec{OA} = \\vec{a}, \\vec{OB} = \\vec{b}$. Khi đó, góc $\\widehat{AOB}$ ($0^\\circ \\le \\widehat{AOB} \\le 180^\\circ$) được gọi là **góc giữa hai vectơ** $\\vec{a}$ và $\\vec{b}$, kí hiệu là $(\\vec{a}, \\vec{b})$.",
    "",
    "[Hình ảnh: Hình 2.22. Biểu diễn góc giữa hai vectơ $\\vec{a}$ và $\\vec{b}$.]",
    "*Hình 2.22*",
    "[Hình ảnh: Học sinh nữ vẫy tay nói: Nếu góc giữa hai vectơ $\\vec{a}$ và $\\vec{b}$ là $90^\\circ$ thì ta nói hai vectơ $\\vec{a}$ và $\\vec{b}$ vuông góc với nhau và kí hiệu là $\\vec{a} \\perp \\vec{b}$.]",
    "",
    "**Chú ý**",
    "- Để xác định góc giữa hai vectơ $\\vec{AB}$ và $\\vec{CD}$ trong không gian ta có thể lấy điểm $E$ sao cho $\\vec{AE} = \\vec{CD}$, khi đó $(\\vec{AB}, \\vec{CD}) = \\widehat{BAE}$ (H.2.23).",
    "- Quy ước góc giữa một vectơ bất kì và $\\vec{0}$ có thể nhận một giá trị tuỳ ý từ $0^\\circ$ đến $180^\\circ$.",
    "[Hình ảnh: Hình 2.23. Góc $\\alpha$ giữa hai vectơ.]",
    "[Hình ảnh: Robot hoạt hình hỏi:]",
    ...
    "a) $\\vec{AD}$ và $\\vec{B'C'}$;",
    "b) $\\vec{AC}$ và $\\vec{A'D'}$.",
    "[Hình ảnh: Hình 2.24. Hình lập phương $ABCD.A'B'C'D'$ có các vectơ xanh lá $\\vec{AD}, \\vec{B'C'}$ và đỏ $\\vec{AC}, \\vec{A'D'}$.]",
    "**Giải**",
    "a) Hai vectơ $\\vec{AD}$ và $\\vec{B'C'}$ cùng hướng nên $(\\vec{AD}, \\vec{B'C'}) = 0^\\circ$.",
    "b) Vì tứ giác $ADD'A'$ là hình bình hành nên $\\vec{AD} = \\vec{A'D'}$.",
    "Do đó $(\\vec{AC}, \\vec{A'D'}) = (\\vec{AC}, \\vec{AD}) = \\widehat{CAD}$. Tam giác $ADC$ vuông cân tại $D$ nên $\\widehat{CAD} = 45^\\circ$, vì vậy $(\\vec{AC}, \\vec{A'D'}) = 45^\\circ$.",
    "",
    "**Luyện tập 9.** Cho hình lăng trụ tam giác đều $ABC.A'B'C'$ (H.2.25). Tính các góc $(\\vec{AA'}, \\vec{BC'})$ và $(\\vec{AB}, \\vec{A'C'})$.",
    "[Hình ảnh: Hình 2.25. Hình lăng trụ tam giác đều $ABC.A'B'C'$.]",
    "",
    ...
    "a) $\\vec{AS} \\cdot \\vec{BC}$;",
    "b) $\\vec{AS} \\cdot \\vec{AC}$.",
    "[Hình ảnh: Hình 2.26. Hình chóp tứ giác đều S.ABCD.]",
    "**Giải**",
    "a) Tam giác $SAD$ có ba cạnh bằng nhau nên là tam giác đều, suy ra $\\widehat{SAD} = 60^\\circ$. Tứ giác $ABCD$ là hình vuông nên $\\vec{AD} = \\vec{BC}$, suy ra $(\\vec{AS}, \\vec{BC}) = (\\vec{AS}, \\vec{AD}) = \\widehat{SAD} = 60^\\circ$. Do đó",
    "$\\vec{AS} \\cdot \\vec{BC} = |\\vec{AS}| \\cdot |\\vec{BC}| \\cdot \\cos 60^\\circ = a \\cdot a \\cdot \\frac{1}{2} = \\frac{a^2}{2}$.",
    "",
    "56",
    "b) Tứ giác $ABCD$ là hình vuông có độ dài mỗi cạnh là $a$ nên độ dài đường chéo $AC$ là $\\sqrt{2}a$. Tam giác $SAC$ có $SA = SC = a$ và $AC = \\sqrt{2}a$ nên tam giác $SAC$ vuông cân tại $S$, suy ra $\\widehat{SAC} = 45^\\circ$. Do đó $\\vec{AS} \\cdot \\vec{AC} = |\\vec{AS}| \\cdot |\\vec{AC}| \\cdot \\cos \\widehat{SAC} = a \\cdot \\sqrt{2}a \\cdot \\frac{\\sqrt{2}}{2} = a^2$.",
    "",
    "**Luyện tập 10.** Trong Ví dụ 10, hãy tính các tích vô hướng $\\vec{AS} \\cdot \\vec{BD}$ và $\\vec{AS} \\cdot \\vec{CD}$.",
    "",
    ...
    "a) $\\vec{MN} = \\frac{1}{2}(\\vec{AC} + \\vec{BD})$;",
    "b) $\\vec{MN} \\cdot \\vec{AB} = 0$.",
    "[Hình ảnh: Hình 2.27. Tứ diện ABCD.]",
    "**Giải**",
    "a) Ta có: $\\vec{MN} = \\vec{MA} + \\vec{AC} + \\vec{CN}$ và $\\vec{MN} = \\vec{MB} + \\vec{BD} + \\vec{DN}$.",
    "Do đó $2\\vec{MN} = (\\vec{MA} + \\vec{MB}) + (\\vec{AC} + \\vec{BD}) + (\\vec{CN} + \\vec{DN})$.",
    "Vì $M, N$ lần lượt là trung điểm của $AB, CD$ nên $\\vec{MA} + \\vec{MB} = \\vec{CN} + \\vec{DN} = \\vec{0}$.",
    "Suy ra $2\\vec{MN} = \\vec{AC} + \\vec{BD}$, hay $\\vec{MN} = \\frac{1}{2}(\\vec{AC} + \\vec{BD})$.",
    "b) Từ giả thiết, ta có $\\vec{AC} \\cdot \\vec{AB} = \\vec{BD} \\cdot \\vec{AB} = 0$.",
    "Vì vậy, $\\vec{MN} \\cdot \\vec{AB} = \\frac{1}{2}(\\vec{AC} + \\vec{BD}) \\cdot \\vec{AB} = \\frac{1}{2}\\vec{AC} \\cdot \\vec{AB} + \\frac{1}{2}\\vec{BD} \\cdot \\vec{AB} = 0$.",
    "",
    "**Luyện tập 11.** Cho hình lập phương $ABCD.A'B'C'D'$. Chứng minh rằng $\\vec{A'C} \\cdot \\vec{B'D'} = 0$.",
    "",
    "**Vận dụng 4.** Như đã biết, nếu có một lực $\\vec{F}$ tác động vào một vật tại điểm $M$ và làm cho vật đó di chuyển một quãng đường $MN$ thì công $A$ sinh ra được tính theo công thức $A = \\vec{F} \\cdot \\vec{MN}$, trong đó lực $F$ có độ lớn tính bằng Newton, quãng đường $MN$ tính bằng mét và công $A$ tính bằng Jun (H.2.28). Do đó, nếu dùng một lực $\\vec{F}$ có độ lớn không đổi để làm một vật di chuyển một quãng đường không đổi thì công sinh ra sẽ lớn nhất khi lực tác động cùng hướng với chuyển động của vật. Hãy giải thích vì sao.",
    "[Hình ảnh: Hình 2.28. Góc giữa hướng lực $\\vec{F}$ và độ dịch chuyển $\\vec{MN}$.]",
    ...
    "",
    "**2.2.** Cho hình hộp chữ nhật $ABCD.A'B'C'D'$ có $AB = 2, AD = 3$ và $AA' = 4$. Tính độ dài của các vectơ $\\vec{BB'}, \\vec{BD}$ và $\\vec{BD'}$.",
    "",
    ...
    "[Hình ảnh: Hình 2.29. Trọng lực và các phản lực tác dụng lên bàn cân đối.]",
    "",
    "**2.4.** Cho hình hộp $ABCD.A'B'C'D'$. Chứng minh rằng:",
    "a) $\\vec{AB} + \\vec{DD'} + \\vec{C'D'} = \\vec{CC'}$;",
    "b) $\\vec{AB} + \\vec{CD'} - \\vec{CC'} = \\vec{0}$;",
    "c) $\\vec{BC} - \\vec{CC'} + \\vec{DC} = \\vec{A'C}$.",
    "",
    "**2.5.** Cho hình lăng trụ tam giác $ABC.A'B'C'$ có $AA' = \\vec{a}, AB = \\vec{b}$ và $AC = \\vec{c}$. Hãy biểu diễn các vectơ sau qua các vectơ $\\vec{a}, \\vec{b}, \\vec{c}$:",
    "a) $\\vec{AB'}$;",
    "b) $\\vec{B'C}$;",
    "c) $\\vec{BC'}$.",
    "",
    "**2.6.** Cho hình chóp tứ giác $S.ABCD$. Chứng minh rằng tứ giác $ABCD$ là hình bình hành nếu và chỉ nếu $\\vec{SA} + \\vec{SC} = \\vec{SB} + \\vec{SD}$.",
    "",
    "**2.7.** Cho hình chóp $S.ABC$. Trên cạnh $SA$, lấy điểm $M$ sao cho $SM = 2AM$. Trên cạnh $BC$, lấy điểm $N$ sao cho $CN = 2BN$. Chứng minh rằng $\\vec{MN} = \\frac{1}{3}(\\vec{SA} + \\vec{BC}) + \\vec{AB}$.",
    "",
    "**2.8.** Trong Luyện tập 8, ta đã biết trọng tâm của tứ diện $ABCD$ là một điểm $I$ thoả mãn $\\vec{AI} = 3\\vec{IG}$, ở đó G là trọng tâm của tam giác $BCD$. Áp dụng tính chất trên để tính khoảng cách từ trọng tâm của một khối rubik (đồng chất) hình tứ diện đều đến một mặt của nó, biết rằng chiều cao của khối rubik là 8 cm (H.2.30).",
    "[Hình ảnh: Hình 2.30. Khối rubik hình tứ diện đều có chiều cao 8 cm.]",
    "",
    "58",
    "**2.9.** Ba sợi dây không giãn với khối lượng không đáng kể được buộc chung một đầu và được kéo căng về ba hướng khác nhau (H.2.31). Nếu các lực kéo làm cho ba sợi dây ở trạng thái đứng yên thì khi đó ba sợi dây nằm trên cùng một mặt phẳng. Hãy giải thích vì sao.",
    "[Hình ảnh: Hình 2.31. Ba sợi dây buộc chung một mối nút được kéo căng về 3 hướng.]",
    "",
    "**2.10.** Cho hình lăng trụ tứ giác đều $ABCD.A'B'C'D'$ có độ dài mỗi cạnh đáy bằng 1 và độ dài mỗi cạnh bên bằng 2. Hãy tính góc giữa các cặp vectơ sau và tính tích vô hướng của mỗi cặp vectơ đó:",
    "a) $\\vec{AA'}$ và $\\vec{C'C}$;",
    "b) $\\vec{AA'}$ và $\\vec{BC}$;",
    "c) $\\vec{AC}$ và $\\vec{B'A'}$.",
    "",
    ...
    "a) $\\vec{AB} \\cdot \\vec{CD} = \\vec{AC} \\cdot \\vec{CD} + \\vec{BC} \\cdot \\vec{DC}$;",
    "b) $\\vec{AB} \\cdot \\vec{CD} + \\vec{AC} \\cdot \\vec{DB} + \\vec{AD} \\cdot \\vec{BC} = 0$.",
    "",
    "---",
    "**Em có biết?**",
    "Việc phân tích (hay biểu diễn) một vectơ trong không gian qua các vectơ cho trước có thể giúp giải thích một số hiện tượng trong cuộc sống. Ví dụ, khi đi bộ, chân tạo một lực tác động $\\vec{F}$ lên mặt đất. Theo Định luật III Newton, từ mặt đất có một phản lực tác động ngược trở lại bàn chân là $\\vec{F'} = -\\vec{F}$. Lực $\\vec{F'}$ có thể được phân tích thành $\\vec{F'} = \\vec{F'_1} + \\vec{F'_2}$, ở đó $\\vec{F'_1}$ có giá song song với mặt đất và $\\vec{F'_2}$ có giá vuông góc với mặt đất (H.2.32). Vì vậy, chỉ có lực $\\vec{F'_1}$ tạo nên chuyển động tiến về phía trước của người đi bộ. Có thể nhận thấy rằng nếu độ lớn của lực $\\vec{F}$ là không đổi (và khi đó độ lớn của lực $\\vec{F'}$ là không đổi) thì độ lớn của lực $\\vec{F'_1}$ càng lớn nếu giá của lực $\\vec{F}$ càng \"gần\" vị trí song song với mặt đất, tức là góc giữa giá của lực $\\vec{F}$ và mặt đất càng nhỏ.",
    "",
    ...
    "[Hình ảnh: Hình 2.32. Phản lực bàn chân. Hình 2.33. Bàn đạp xuất phát của vận động viên chạy cự ly ngắn.]",
    "",
    "59"
  ]
}
...
INSERT INTO lessons (chapter_id, code, name, page, sort_order, knowledge_json) VALUES
((SELECT id FROM chapters WHERE code = 'CH2' AND textbook_id = (SELECT id FROM textbooks WHERE code = 'TOAN12_T1')), 'B8', 'Tích của một số với một vectơ trong không gian', 60, 3, $JSON$
{
  "content": [
    "# Bài 7",
    ...
    "| THUẬT NGỮ | KIẾN THỨC, KĨ NĂNG |",
    "| :--- | :--- |",
    "| • Hệ trục toạ độ trong không gian<br>• Toạ độ của điểm trong không gian<br>• Toạ độ của vectơ trong không gian | • Nhận biết toạ độ của điểm, của vectơ đối với hệ trục toạ độ.<br>• Vận dụng toạ độ của vectơ để giải một số bài toán có liên quan đến thực tiễn. |",
    "",
    ...
    "[Hình ảnh: Hình 2.34. Chiếc ghế sofa bên cạnh bàn nhỏ, phía trên có đèn treo cách sàn 2m, cách hai tường lần lượt 1m và 1,5m.]",
    "",
    ...
    "[Hình ảnh: Hình 2.35. Hệ trục toạ độ Oxyz đôi một vuông góc với các vectơ đơn vị $\\vec{i}, \\vec{j}, \\vec{k}$.]",
    "",
    "> Trong không gian, ba trục Ox, Oy, Oz đôi một vuông góc tại gốc O của mỗi trục. Gọi $\\vec{i}, \\vec{j}, \\vec{k}$ lần lượt là các vectơ đơn vị trên các trục Ox, Oy, Oz.",
    ...
    "",
    "**Ví dụ 1.** Cho hình lập phương $ABCD.A'B'C'D'$ có độ dài mỗi cạnh bằng 1 (H.2.36). Có thể lập một hệ toạ độ Oxyz có gốc O trùng với đỉnh $B'$ và các vectơ $\\vec{i}, \\vec{j}, \\vec{k}$ lần lượt là các vectơ $\\vec{B'A'}, \\vec{B'C'}, \\vec{B'B}$ không? Giải thích vì sao.",
    "[Hình ảnh: Hình 2.36. Hình lập phương $ABCD.A'B'C'D'$ có các cạnh đứt đoạn xuất phát từ B' được gán các vectơ đỏ $\\vec{B'A'}, \\vec{B'C'}, \\vec{B'B}$.]",
    "**Giải**",
    "Hình lập phương $ABCD.A'B'C'D'$ có các cạnh $B'A', B'C'$ và $B'B$ đôi một vuông góc với nhau.",
    "Vì hình lập phương có độ dài cạnh bằng 1 nên các vectơ $\\vec{B'A'}, \\vec{B'C'}, \\vec{B'B}$ cùng có điểm đầu là $B'$ và đều có độ dài bằng 1.",
    "Từ các điều trên, suy ra có thể lập một hệ toạ độ Oxyz có gốc O trùng với đỉnh $B'$ và các vectơ $\\vec{i}, \\vec{j}, \\vec{k}$ lần lượt là các vectơ $\\vec{B'A'}, \\vec{B'C'}, \\vec{B'B}$.",
    "",
    "**Luyện tập 1.** Cho hình hộp chữ nhật $ABCD.A'B'C'D'$. Có thể lập một hệ toạ độ Oxyz có gốc O trùng với đỉnh $C$ và các vectơ $\\vec{i}, \\vec{j}, \\vec{k}$ lần lượt cùng hướng với các vectơ $\\vec{CB}, \\vec{CD}, \\vec{CC'}$ không? Giải thích vì sao.",
    "",
    ...
    "a) Hai vectơ $\\vec{OM}$ và $\\vec{OA} + \\vec{OB} + \\vec{OC}$ có bằng nhau hay không?",
    "b) Giải thích vì sao có thể viết $\\vec{OM} = x\\vec{i} + y\\vec{j} + z\\vec{k}$ với $x, y, z$ là các số thực.",
    "[Hình ảnh: Hình 2.37. Điểm M trong hệ toạ độ Oxyz tạo nên hình hộp chữ nhật.]",
    "",
    "Người ta chứng minh được rằng với điểm $M$ tuỳ ý, bộ ba số $(x; y; z)$ trong HĐ2 là duy nhất. Ngược lại nếu $\\vec{OM} = x\\vec{i} + y\\vec{j} + z\\vec{k}$ thì điểm $M$ xác định duy nhất.",
    "> Trong không gian Oxyz, cho một điểm $M$ tuỳ ý. Bộ ba số $(x; y; z)$ duy nhất sao cho $\\vec{OM} = x\\vec{i} + y\\vec{j} + z\\vec{k}$ được gọi là **toạ độ của điểm** $M$ đối với hệ toạ độ Oxyz. Khi đó, ta viết $M = (x; y; z)$ hoặc $M(x; y; z)$, trong đó $x$ là **hoành độ**, $y$ là **tung độ** và $z$ là **cao độ** của $M$.",
    "",
    "[Hình ảnh: Robot hoạt hình hỏi:]",
    ...
    "[Hình ảnh: Hình 2.38. Điểm M trong không gian Oxyz.]",
    "**Giải**",
    "Trong Hình 2.38, $ABCM.FODE$ là hình hộp chữ nhật. Áp dụng quy tắc hình hộp suy ra",
    "$\\vec{OM} = \\vec{OF} + \\vec{OD} + \\vec{OB} = 3\\vec{i} + 4\\vec{j} + 3\\vec{k}$.",
    "Vì vậy, toạ độ của điểm $M$ là $(3; 4; 3)$.",
    "",
    "**Luyện tập 2.** Tìm toạ độ của điểm $N$ trong Hình 2.39.",
    "[Hình ảnh: Hình 2.39. Điểm N trong không gian Oxyz.]",
    "",
    ...
    "[Hình ảnh: Hình 2.40. Hình hộp chữ nhật $ABCD.A'B'C'D'$ có A' trùng O.]",
    "**Giải**",
    "Vì đỉnh $D'$ thuộc tia Ox nên hai vectơ $\\vec{OD'}$ và $\\vec{i}$ cùng phương, suy ra có số thực $m$ sao cho $\\vec{OD'} = m\\vec{i}$. Tương tự, có các số thực $n, p$ sao cho $\\vec{OB'} = n\\vec{j}$ và $\\vec{OA} = p\\vec{k}$. Theo quy tắc hình hộp, suy ra $\\vec{OC} = \\vec{OD'} + \\vec{OB'} + \\vec{OA} = m\\vec{i} + n\\vec{j} + p\\vec{k}$ và do đó điểm $C$ có toạ độ là $(m; n; p)$.",
    "Mặt khác, đỉnh $C$ có toạ độ là $(2; 3; 5)$ nên $m = 2, n = 3, p = 5$, tức là $\\vec{OD'} = 2\\vec{i}, \\vec{OB'} = 3\\vec{j}$ và $\\vec{OA} = 5\\vec{k}$.",
    ...
    "Trong không gian Oxyz, cho vectơ $\\vec{a}$ tuỳ ý (H.2.41). Lấy điểm $M$ sao cho $\\vec{OM} = \\vec{a}$ và giải thích vì sao có ba số $(x; y; z)$ sao cho $\\vec{a} = x\\vec{i} + y\\vec{j} + z\\vec{k}$.",
    "[Hình ảnh: Hình 2.41. Vectơ $\\vec{a}$ bằng vectơ $\\vec{OM}$ trong hệ trục toạ độ.]",
    "",
    "62",
    ...
    "**Giải**",
    "Vì $\\vec{i} = 1\\vec{i} + 0\\vec{j} + 0\\vec{k}$ nên $\\vec{i} = (1; 0; 0)$.",
    "Vì $\\vec{j} = 0\\vec{i} + 1\\vec{j} + 0\\vec{k}$ nên $\\vec{j} = (0; 1; 0)$.",
    "Vì $\\vec{k} = 0\\vec{i} + 0\\vec{j} + 1\\vec{k}$ nên $\\vec{k} = (0; 0; 1)$.",
    "",
    ...
    "[Hình ảnh: Hình 2.42. Hình lăng trụ tam giác $ABC.A'B'C'$.]",
    "**Giải** (H.2.42)",
    ...
    "",
    "63",
    "Do đó $\\begin{cases} x - 3 = 4 \\\\ y - 2 = 0 \\\\ z - 5 = -1 \\end{cases}$ hay $\\begin{cases} x = 7 \\\\ y = 2 \\\\ z = 4 \\end{cases}$. Vậy $B'(7; 2; 4)$.",
    "Lập luận tương tự suy ra $C'(11; -3; 8)$.",
    "",
    "**Luyện tập 5.** Trong Ví dụ 5, xác định toạ độ của điểm $D$ và $D'$ sao cho $ABCD.A'B'C'D'$ là hình hộp.",
    "",
    ...
    "[Hình ảnh: Hình 2.43. Đài kiểm soát không lưu sân bay lúc hoàng hôn, có máy bay đang bay.]",
    "",
    "# BÀI TẬP",
    "",
    ...
    "",
    "**2.14.** Hãy mô tả hệ toạ độ Oxyz trong căn phòng ở Hình 2.44 sao cho gốc O trùng với góc trên của căn phòng, khung tranh nằm trong mặt phẳng $(Oxy)$ và mặt trần nhà trùng với mặt phẳng $(Ozx)$.",
    "[Hình ảnh: Hình 2.44. Căn phòng trống có khung tranh treo trên tường gần cửa sổ.]",
    "",
    "64",
    "**2.15.** Trong không gian Oxyz, xác định toạ độ của vectơ $\\vec{AB}$ trong mỗi trường hợp sau:",
    ...
    "[Hình ảnh: Hình 2.45. Hình hộp chữ nhật $ABCD.A'B'C'D'$ có A trùng O.]",
    "",
    ...
    "Với mỗi điểm $M$ trong không gian Oxyz, gọi $M'$ là hình chiếu vuông góc của $M$ trên mặt phẳng $(Oxy)$. Gọi $r$ là khoảng cách từ O đến $M$, gọi $\\theta$ ($0 \\le \\theta \\le 2\\pi$) là số đo của góc lượng giác (trong mặt phẳng $(Oxy)$) có tia đầu là Ox, tia cuối là $OM'$ và gọi $\\phi$ ($0 \\le \\phi \\le \\pi$) là số đo của góc tạo bởi hai tia $OM$ và $Oz$ (H.2.46). Bộ ba $(r; \\theta; \\phi)$ được gọi là toạ độ cầu của điểm $M$, trong đó $r$ là bán kính, $\\theta$ là góc phương vị hay góc kinh độ và $\\phi$ là góc cực của $M$.",
    "[Hình ảnh: Chân dung René Descartes (1596 - 1650), nhà triết học, toán học người Pháp.]",
    "",
    "65",
    "Toạ độ cầu $(r; \\theta; \\phi)$ và toạ độ Descartes $(x; y; z)$ của $M$ liên hệ với nhau qua các công thức:",
    "$\\begin{cases} r = \\sqrt{x^2 + y^2 + z^2} \\\\ \\tan \\theta = \\frac{y}{x} \\\\ \\cos \\phi = \\frac{z}{\\sqrt{x^2 + y^2 + z^2}} \\end{cases}$ và $\\begin{cases} x = r \\cos \\theta \\sin \\phi \\\\ y = r \\sin \\theta \\sin \\phi \\\\ z = r \\cos \\phi \\end{cases}$.",
    "[Hình ảnh: Hình 2.46. Mô hình biểu diễn toạ độ cầu của điểm M.]",
    "",
    "Trong một số trường hợp, người ta thay góc cực $\\phi$ bởi góc nâng (hay góc vĩ độ) $\\psi = \\frac{\\pi}{2} - \\phi$ $\\left(-\\frac{\\pi}{2} \\le \\psi \\le \\frac{\\pi}{2}\\right)$. Khi đó toạ độ cầu $(r; \\theta; \\psi)$ và toạ độ Descartes $(x; y; z)$ cũng được liên hệ với nhau bởi các công thức tương tự như trên.",
...
INSERT INTO lessons (chapter_id, code, name, page, sort_order, knowledge_json) VALUES
((SELECT id FROM chapters WHERE code = 'CH2' AND textbook_id = (SELECT id FROM textbooks WHERE code = 'TOAN12_T1')), 'B9', 'Biểu thức tọa độ của vectơ trong không gian', 67, 4, $JSON$
{
  "content": [
    "# Bài 8",
    ...
    "| KIẾN THỨC, KĨ NĂNG |",
    "| :--- |",
    "| • Nhận biết biểu thức toạ độ của các phép toán vectơ trong không gian, thể hiện các phép toán vectơ theo toạ độ, xác định độ dài của một vectơ khi biết toạ độ hai đầu mút.<br>• Vận dụng biểu thức toạ độ của các phép toán vectơ để giải một số bài toán có liên quan đến thực tiễn. |",
    "",
    ...
    "[Hình ảnh: Hình 2.47a. Dãy nhà gỗ có mái hình tam giác. Hình 2.47b. Phác thảo hình lăng trụ đứng tam giác OAB.O'A'B' trong hệ toạ độ Oxyz.]",
    "",
    "## 1. BIỂU THỨC TOẠ ĐỘ CỦA PHÉP CỘNG HAI VECTƠ, PHÉP TRỪ HAI VECTƠ, PHÉP NHÂN MỘT SỐ VỚI VỘT VECTƠ",
    ...
    "[Hình ảnh: Hộp thoại ghi nhớ kiến thức đã biết:]",
    "Ta đã biết:",
    ...
    "> - Toạ độ trọng tâm của tam giác $ABC$ là $\\left(\\frac{x_A + x_B + x_C}{3}; \\frac{y_A + y_B + x_C}{3}; \\frac{z_A + z_B + z_C}{3}\\right)$.",
    "",
    ...
    "b) Tính $BD$ và $SC$.",
    "c) Tính $(\\vec{BD}, \\vec{SC})$.",
    "[Hình ảnh: Hình 2.48. Hình chóp S.ABCD dựng trong hệ trục toạ độ Oxyz.]",
    "**Giải**",
    ...
    "",
    "69",
    "b) Ta có $\\vec{BD} = (0 - 3; 4 - 0; 0 - 0) = (-3; 4; 0)$, suy ra $BD = |\\vec{BD}| = \\sqrt{(-3)^2 + 4^2 + 0^2} = 5$.",
    "Ta có $\\vec{SC} = (3 - 0; 4 - 0; 0 - 2) = (3; 4; -2)$, suy ra $SC = |\\vec{SC}| = \\sqrt{3^2 + 4^2 + (-2)^2} = \\sqrt{29}$.",
    "c) Ta có $\\cos(\\vec{BD}, \\vec{SC}) = \\frac{\\vec{BD} \\cdot \\vec{SC}}{|\\vec{BD}| \\cdot |\\vec{SC}|} = \\frac{(-3) \\cdot 3 + 4 \\cdot 4 + 0 \\cdot (-2)}{5\\sqrt{29}} = \\frac{7}{5\\sqrt{29}}$, suy ra $(\\vec{BD}, \\vec{SC}) \\approx 74,9^\\circ$.",
    "",
    "**Chú ý.** Nếu $A(x_A; y_A; z_A)$ và $B(x_B; y_B; z_B)$ thì $AB = |\\vec{AB}| = \\sqrt{(x_B - x_A)^2 + (y_B - y_A)^2 + (z_B - z_A)^2}$.",
    ...
    "[Hình ảnh: Máy bay đang bay trên trời và hình minh hoạ các điểm A, B, C thẳng hàng trên đường bay.]",
    "*Hình 2.49*",
    "**Giải** (H.2.49)",
    "Gọi $C(x; y; z)$ là vị trí của máy bay sau 5 phút tiếp theo. Vì hướng của máy bay không đổi nên $\\vec{AB}$ và $\\vec{BC}$ cùng hướng. Do vận tốc của máy bay không đổi và thời gian bay từ $A$ đến $B$ gấp đôi thời gian bay từ $B$ đến $C$ nên $AB = 2BC$.",
    "Do đó $\\vec{BC} = \\frac{1}{2}\\vec{AB} = \\left(\\frac{940 - 800}{2}; \\frac{550 - 500}{2}; \\frac{8 - 7}{2}\\right) = (70; 25; 0,5)$.",
    "Mặt khác, $\\vec{BC} = (x - 940; y - 550; z - 8)$ nên $\\begin{cases} x - 940 = 70 \\\\ y - 550 = 25 \\\\ z - 8 = 0,5 \\end{cases} \\Rightarrow \\begin{cases} x = 1010 \\\\ y = 575 \\\\ z = 8,5 \\end{cases}$.",
    "Từ đó suy ra $C(1010; 575; 8,5)$.",
    ...
    "**Giải.** Vì điểm $A'$ có toạ độ là $(240; 450; 0)$ nên khoảng cách từ $A'$ đến các trục Ox, Oy lần lượt là $450\\text{ cm}$ và $240\\text{ cm}$. Suy ra $A'A = 450\\text{ cm}$ và $A'O' = 240\\text{ cm}$. Từ giả thiết suy ra $\\vec{A'B'} = (-120; 0; 300)$, do đó $A'B' = |\\vec{A'B'}| = \\sqrt{(-120)^2 + 0^2 + 300^2} = 60\\sqrt{29} \\approx 323\\text{ (cm)}$.",
    "Vì $O'O = A'A = 450\\text{ cm}$ và $O'$ nằm trên trục Oy nên toạ độ của điểm $O'$ là $(0; 450; 0)$.",
    "Do đó $\\vec{O'B'} = (120; 0; 300)$ và $O'B' = |\\vec{O'B'}| = \\sqrt{120^2 + 0^2 + 300^2} = 60\\sqrt{29} \\approx 323\\text{ (cm)}$.",
    ...
    "[Hình ảnh: Góc $\\alpha$ chính là góc giữa mặt bên của căn nhà gỗ và mặt đất.]",
    "",
    ...
    "[Hình ảnh: Hình 2.50. Hai chiếc khinh khí cầu bay trên bầu trời trong hệ toạ độ Oxyz.]",
    "**Giải**",
    ...
    "a) Tìm toạ độ của các vectơ $\\vec{MN}, \\vec{MP}$, từ đó chứng minh rằng ba điểm $M, N, P$ không thẳng hàng.",
    "b) Tìm toạ độ của vectơ $\\vec{NM} + \\vec{NP}$, từ đó suy ra toạ độ của điểm $Q$ sao cho tứ giác $MNPQ$ là hình bình hành.",
    ...
    "[Hình ảnh: Hình 2.51. Phòng học hình hộp chữ nhật trong hệ trục toạ độ Oxyz.]",
    "",
    ...
    "[Hình ảnh: Hình 2.52. Giàn khoan dầu khí trên biển đêm.]",
    "",
    "72",
    ...
    "",
    "**2.26.** Cho hình hộp $ABCD.A'B'C'D'$. Lấy $M$ là trung điểm của đoạn thẳng $CC'$. Vectơ $\\vec{AM}$ bằng",
    ...
    "",
    "**2.28.** Cho tứ diện đều $ABCD$ có độ dài cạnh bằng a, gọi $M$ là trung điểm của đoạn thẳng $CD$. Tích vô hướng $\\vec{AB} \\cdot \\vec{AM}$ bằng",
    "A. $\\frac{a^2}{4}$.",
    "B. $\\frac{a^2}{2}$.",
    "C. $\\frac{a^2}{3}$.",
    "D. $a^2$.",
    "",
    "**2.29.** Trong không gian Oxyz, cho $\\vec{a} = (1; -2; 2), \\vec{b} = (-2; 0; 3)$. Khẳng định nào dưới đây là sai?",
    "A. $\\vec{a} + \\vec{b} = (-1; -2; 5)$.",
    "B. $\\vec{a} - \\vec{b} = (3; -2; -1)$.",
    "C. $3\\vec{a} = (3; -2; 2)$.",
    "D. $2\\vec{a} + \\vec{b} = (0; -4; 7)$.",
    "",
    "**2.30.** Trong không gian Oxyz, cho hình bình hành $ABCD$ có $A(-1; 0; 3), B(2; 1; -1)$ và $C(3; 2; 2)$. Toạ độ của điểm $D$ là",
    "A. $(2; -1; 0)$.",
    "B. $(0; -1; -6)$.",
    "C. $(0; 1; 6)$.",
    "D. $(-2; 1; 0)$.",
    "",
    "**2.31.** Trong không gian Oxyz, cho $A(1; 0; -1), B(0; -1; 2)$ và $G(2; 1; 0)$. Biết tam giác $ABC$ có trọng tâm là điểm $G$. Toạ độ của điểm $C$ là",
    "A. $(5; 4; -1)$.",
    "B. $(-5; -4; 1)$.",
    "C. $(1; 2; -1)$.",
    "D. $(-1; -2; 1)$.",
    "",
    "**2.32.** Trong không gian Oxyz, cho $\\vec{a} = (2; 1; -3), \\vec{b} = (-2; -1; 2)$. Tích vô hướng $\\vec{a} \\cdot \\vec{b}$ bằng",
    "A. $-2$.",
    "B. $-11$.",
    "C. $11$.",
    "D. $2$.",
    "",
    "**2.33.** Trong không gian Oxyz, cho $\\vec{a} = (2; 1; -2), \\vec{b} = (0; -1; 1)$. Góc giữa hai vectơ $\\vec{a}, \\vec{b}$ bằng",
    "A. $60^\\circ$.",
    "B. $135^\\circ$.",
    "C. $120^\\circ$.",
    "D. $45^\\circ$.",
    "",
    "73",
    "**2.34.** Trong không gian Oxyz, cho $\\vec{a} = (-2; 2; 2), \\vec{b} = (1; -1; -2)$. Côsin của góc giữa hai vectơ $\\vec{a}, \\vec{b}$ bằng",
    "A. $\\frac{-2\\sqrt{2}}{3}$.",
    "B. $\\frac{2\\sqrt{2}}{3}$.",
    "C. $\\frac{\\sqrt{2}}{3}$.",
    "D. $\\frac{-\\sqrt{2}}{3}$.",
    ...
    "",
    "**2.36.** Cho tứ diện $ABCD$, lấy hai điểm $M, N$ thoả mãn $\\vec{MB} + 2\\vec{MA} = \\vec{0}$ và $\\vec{NC} = 2\\vec{DN}$. Hãy biểu diễn $\\vec{MN}$ theo $\\vec{AD}$ và $\\vec{BC}$.",
    "",
    ...
    "",
    "**2.38.** Trong không gian Oxyz, cho các điểm $A(2; -1; 3), B(1; 1; -1)$ và $C(-1; 0; 2)$.",
    ...
    "",
    "**2.39.** Trong không gian Oxyz, cho hình hộp $OABC.O'A'B'C'$ và các điểm $A(2; 3; 1), C(-1; 2; 3)$ và $O'(1; -2; 2)$. Tìm toạ độ các đỉnh còn lại của hình hộp.",
    "",
    "**2.40.** Trong không gian Oxyz, cho hai vectơ $\\vec{a} = (-2; 1; 2), \\vec{b} = (1; 1; -1)$.",
    "a) Xác định toạ độ của vectơ $\\vec{u} = \\vec{a} - 2\\vec{b}$.",
    "b) Tính độ dài vectơ $\\vec{u}$.",
    "c) Tính $\\cos(\\vec{a}, \\vec{b})$.",
    "",
    "**2.41.** Trong không gian Oxyz, cho các điểm $A(4; 2; -1), B(1; -1; 2)$ và $C(0; -2; 3)$.",
    "a) Tìm toạ độ của vectơ $\\vec{AB}$ và tính độ dài đoạn thẳng $AB$.",
    "b) Tìm toạ độ điểm $M$ sao cho $\\vec{AB} + \\vec{CM} = \\vec{0}$.",
    "c) Tìm toạ độ điểm $N$ thuộc mặt phẳng $(Oxy)$, sao cho $A, B, N$ thẳng hàng.",
    "",
    "**2.42.** Hình 2.53 minh hoạ một chiếc đèn được treo cách trần nhà là 0,5 m, cách hai tường lần lượt là 1,2 m và 1,6 m. Hai bức tường vuông góc với nhau và cùng vuông góc với trần nhà. Người ta di chuyển chiếc đèn đó đến vị trí mới cách trần nhà là 0,4 m, cách hai tường đều là 1,5 m.",
    ...
    "[Hình ảnh: Hình 2.53. Chiếc đèn treo cách trần 0,5m, cách hai tường lần lượt 1,2m và 1,6m.]",
    "",
    "74"
  ]
}
...
INSERT INTO lessons (chapter_id, code, name, page, sort_order, knowledge_json) VALUES
((SELECT id FROM chapters WHERE code = 'CH3' AND textbook_id = (SELECT id FROM textbooks WHERE code = 'TOAN12_T1')), 'B9', 'Khoảng biến thiên và khoảng tứ phân vị', 75, 1, $JSON$
{
  "content": [
    "# CHƯƠNG III",
    ...
    "[Hình ảnh: Biểu đồ cột biểu diễn xu hướng dữ liệu qua các năm từ 2017 đến 2022.]",
    ...
    "| THUẬT NGỮ | KIẾN THỨC, KĨ NĂNG |",
    "| :--- | :--- |",
    "| • Khoảng biến thiên<br>• Khoảng tứ phân vị | • Tính khoảng biến thiên, khoảng tứ phân vị của mẫu số liệu ghép nhóm.<br>• Hiểu ý nghĩa, vai trò của khoảng biến thiên, khoảng tứ phân vị trong việc đo mức độ phân tán. |",
    "",
    ...
    "75",
    "## 1. KHOẢNG BIẾN THIÊN",
    "**HĐ1.** Trong tình huống mở đầu, gọi $x_1, x_2, ..., x_{30}$ là nhiệt độ cao nhất trong ngày của 30 ngày tháng Sáu năm 2021 (mẫu số liệu gốc).",
    ...
    "",
    "## 2. KHOẢNG TỨ PHÂN VỊ",
    "**HĐ2.** Trong tình huống mở đầu, gọi $y_1, y_2, ..., y_{30}$ là nhiệt độ cao nhất trong ngày của 30 ngày tháng Sáu năm 2022 (mẫu số liệu gốc).",
    ...
    "[Hình ảnh: Hộp thoại công thức tính Tứ phân vị thứ r:]",
    "Tứ phân vị thứ r là",
    "$Q_r = a_p + \\frac{\\frac{r \\cdot n}{4} - (m_1 + ... + m_{p-1})}{m_p} \\cdot (a_{p+1} - a_p)$,",
    ...
    "77",
    "**Giải**",
    "a) Cỡ mẫu là $n = 3 + 12 + 15 + 8 = 38$. Gọi $x_1, ..., x_{38}$ là thời gian chờ khám bệnh của 38 bệnh nhân này và giả sử rằng dãy số liệu gốc này đã được sắp xếp theo thứ tự tăng dần.",
...
INSERT INTO lessons (chapter_id, code, name, page, sort_order, knowledge_json) VALUES
((SELECT id FROM chapters WHERE code = 'CH3' AND textbook_id = (SELECT id FROM textbooks WHERE code = 'TOAN12_T1')), 'B10', 'Phương sai và độ lệch chuẩn', 80, 2, $JSON$
{
  "content": [
    "# Bài 10",
    ...
    "| THUẬT NGỮ | KIẾN THỨC, KĨ NĂNG |",
    "| :--- | :--- |",
    "| • Phương sai<br>• Độ lệch chuẩn | • Tính phương sai, độ lệch chuẩn của mẫu số liệu ghép nhóm.<br>• Hiểu ý nghĩa, vai trò của phương sai, độ lệch chuẩn trong việc đo mức độ phân tán. |",
    "",
    ...
    "**HĐ1.** Trở lại bài toán trong tình huống mở đầu. Gọi $x_1, ..., x_{20}$ là các kết quả đo (mẫu số liệu gốc).",
    ...
    "> $s^2 = \\frac{m_1(x_1 - \\bar{x})^2 + ... + m_k(x_k - \\bar{x})^2}{n}$;",
    "> trong đó, $n = m_1 + ... + m_k$; $x_i = \\frac{a_i + a_{i+1}}{2}$ với $i = 1, 2, ..., k$ là giá trị đại diện cho nhóm $[a_i; a_{i+1})$ và $\\bar{x} = \\frac{m_1 x_1 + ... + m_k x_k}{n}$ là số trung bình của mẫu số liệu ghép nhóm.",
    ...
    "",
    "**Nhận xét.** Ta có thể tính phương sai theo công thức: $s^2 = \\frac{1}{n}\\left(m_1 \\cdot x_1^2 + ... + m_k \\cdot x_k^2\\right) - (\\bar{x})^2$.",
    ...
    "$\\hat{s}^2 = \\frac{m_1(x_1 - \\bar{x})^2 + ... + m_k(x_k - \\bar{x})^2}{n - 1}$, $\\hat{s} = \\sqrt{\\hat{s}^2}$.",
    "",
    ...
    "$\\bar{x}_1 = \\frac{1}{15}[2 \\cdot (-0,5) + 3 \\cdot 0,5 + 5 \\cdot 1,5 + 3 \\cdot 2,5 + 2 \\cdot 3,5] = 1,5$ (kg).",
    "Thay đổi cân nặng trung bình của người nữ là:",
    "$\\bar{x}_2 = \\frac{1}{30}[2 \\cdot (-0,5) + 7 \\cdot 0,5 + 12 \\cdot 1,5 + 7 \\cdot 2,5 + 2 \\cdot 3,5] = 1,5$ (kg).",
    "Phương sai và độ lệch chuẩn của mẫu số liệu về thay đổi cân nặng của người nam là:",
    "$s_1^2 = \\frac{1}{15}[2 \\cdot (-0,5)^2 + 3 \\cdot 0,5^2 + 5 \\cdot 1,5^2 + 3 \\cdot 2,5^2 + 2 \\cdot 3,5^2] - 1,5^2 \\approx 1,21^2$; $s_1 \\approx 1,21$.",
    "Phương sai và độ lệch chuẩn của mẫu số liệu về thay đổi cân nặng của người nữ là:",
    "$s_2^2 = \\frac{1}{30}[2 \\cdot (-0,5)^2 + 7 \\cdot 0,5^2 + 12 \\cdot 1,5^2 + 7 \\cdot 2,5^2 + 2 \\cdot 3,5^2] - 1,5^2 \\approx 2,06^2$; $s_2 \\approx 2,06$.",
    ...
    "",
    "**Vận dụng.** Hãy tính độ lệch chuẩn cho bài toán trong tình huống mở đầu và cho biết có cần đưa máy đi sửa chữa hay không.",
    "",
    ...
    "$\\bar{x}_A = \\frac{1}{60}(5 \\cdot 7,5 + 10 \\cdot 12,5 + 30 \\cdot 17,5 + 10 \\cdot 22,5 + 5 \\cdot 27,5) = 17,5$ (triệu đồng);",
    "$\\bar{x}_B = \\frac{1}{60}(20 \\cdot 7,5 + 5 \\cdot 12,5 + 10 \\cdot 17,5 + 5 \\cdot 22,5 + 20 \\cdot 27,5) = 17,5$ (triệu đồng).",
    ...
    "$s_A = \\sqrt{\\frac{1}{60}(5 \\cdot 7,5^2 + 10 \\cdot 12,5^2 + 30 \\cdot 17,5^2 + 10 \\cdot 22,5^2 + 5 \\cdot 27,5^2) - (17,5)^2} = 5$;",
    "$s_B = \\sqrt{\\frac{1}{60}(20 \\cdot 7,5^2 + 5 \\cdot 12,5^2 + 10 \\cdot 17,5^2 + 5 \\cdot 22,5^2 + 20 \\cdot 27,5^2) - (17,5)^2} \\approx 8,42$.",
    ...
    "",
    "**3.6.** Một nhóm 20 học sinh dùng một thiết bị đo đường kính của một nhân tế bào cho kết quả như sau:",
...
INSERT INTO lessons (chapter_id, code, name, page, sort_order, knowledge_json) VALUES
((SELECT id FROM chapters WHERE code = 'CH3' AND textbook_id = (SELECT id FROM textbooks WHERE code = 'TOAN12_T1')), 'B11', 'B?i t?p cu?i ch??ng III', 85, 3, $JSON$
{
  "content": [
    "# B?I T?P CU?I CH??NG III",
    "",
    "## A - TR?C NGHI?M",
    "",
    "*S? d?ng d? ki?n sau ?? tr? l?i c?u h?i trong c?c b?i t?p t? 3.9 ??n 3.13.*",
    "M?t v??n th? ghi l?i tu?i th? (??n v?: n?m) c?a 20 con h? v? thu ???c k?t qu? nh? sau:",
    "| Tu?i th? | [14; 15) | [15; 16) | [16; 17) | [17; 18) | [18; 19) |",
    "| :--- | :---: | :---: | :---: | :---: | :---: |",
    "| S? con h? | 1 | 3 | 8 | 6 | 2 |",
    "",
    "**3.9.** Kho?ng bi?n thi?n c?a m?u s? li?u gh?p nh?m n?y l?",
    "A. 3.",
    "B. 4.",
    "C. 5.",
    "D. 6.",
    "",
    "**3.10.** Nh?m ch?a t? ph?n v? th? nh?t l?",
    "A. [14; 15).",
    "B. [15; 16).",
    "C. [16; 17).",
    "D. [17; 18).",
    "",
    "**3.11.** Nh?m ch?a t? ph?n v? th? ba l?",
    "A. [15; 16).",
    "B. [16; 17).",
    "C. [17; 18).",
    "D. [18; 19).",
    "",
    "**3.12.** S? ??c tr?ng n?o kh?ng s? d?ng th?ng tin c?a nh?m s? li?u ??u ti?n v? nh?m s? li?u cu?i c?ng?",
    "A. Kho?ng bi?n thi?n.",
    "B. Kho?ng t? ph?n v?.",
    "C. Ph??ng sai.",
    "D. ?? l?ch chu?n.",
    "",
    "**3.13.** N?u thay t?t c? c?c t?n s? trong m?u s? li?u gh?p nh?m tr?n b?ng 4 th? s? ??c tr?ng n?o sau ??y kh?ng thay ??i?",
    "A. Kho?ng bi?n thi?n.",
    "B. Kho?ng t? ph?n v?.",
    "C. Ph??ng sai.",
    "D. ?? l?ch chu?n."
...
$JSON$) ON CONFLICT DO NOTHING;
INSERT INTO lessons (chapter_id, code, name, page, sort_order, knowledge_json) VALUES
((SELECT id FROM chapters WHERE code = 'CH4' AND textbook_id = (SELECT id FROM textbooks WHERE code = 'TOAN12_T1')), 'B12', 'Khảo sát và vẽ đồ thị hàm số với phần mềm GeoGebra', 87, 1, $JSON$
{
  "content": [
    ...
    "",
    "Khởi động phần mềm GeoGebra [Biểu tượng GeoGebra], chọn Complex Adaptive System (CAS) để thực hiện tính toán đạo hàm, tìm cực trị, tìm giá trị lớn nhất (GTLN), giá trị nhỏ nhất (GTNN) của hàm số và tìm các đường tiệm cận của đồ thị hàm số; chọn Graphics 2 để vẽ đồ thị của hàm số.",
    "",
    ...
    "Nhấn nút ở đầu lệnh [Biểu tượng nút tròn], lúc này tên của hàm số được phần mềm đặt tự động. Sau đó, để tính đạo hàm của hàm số tại một điểm xác định, ta thay giá trị của biến vào hàm đạo hàm của hàm số đó, kết quả sẽ được hiển thị ngay bên dưới.",
    "```",
    "1   f(x) := Derivative(x^5 - 4x^3 + 2x - 3)",
    "    -> f(x) := 5x^4 - 12x^2 + 2",
    "2   f(2)",
    "    -> 34",
    "```",
    ...
    "$f^{(n)}(x) = (f^{(n-1)}(x))'$.",
    "",
    "## 2. TÌM CỰC TRỊ, GIÁ TRI LỚN NHẤT, GIÁ TRỊ NHỎ NHẤT (NẾU CÓ) CỦA HÀM SỐ",
    ...
    "",
    "**Chú ý.** Ta có thể quan sát kênh hình để có hình ảnh trực quan bằng cách chọn View $\\rightarrow$ Graphics 2.",
    ...
    "Để tìm giá trị lớn nhất của hàm số trên một đoạn $[a; b]$ cho trước, ta dùng lệnh `Max(<hàm số>, <a>, <b>)`; kết quả trả về sẽ là toạ độ của một điểm, tung độ của điểm đó chính là giá trị lớn nhất cần tìm.",
    "```",
    ...
    "",
    "## 4. VẼ ĐỒ THỊ HÀM SỐ",
    "Khởi động GeoGebra và chọn View $\\rightarrow$ Graphics 2 để vẽ đồ thị của hàm số. Khi đó, màn hình hiển thị sẵn hệ trục toạ độ dạng lưới ô vuông.",
    ...
    "[Hình ảnh: Hình T.1. Đồ thị hàm đa thức $y = x^3 - 3x^2 - 9x + 10$ được vẽ trên phần mềm GeoGebra.]",
    "*Hình T.1*",
    "",
    "89",
    "### b) Vẽ đồ thị của hàm phân thức",
    "- *Bước 1.* Vẽ tiệm cận của đồ thị hàm phân thức bằng cách sử dụng câu lệnh đã được giới thiệu trong Mục 3.",
    "- *Bước 2.* Vẽ đồ thị hàm phân thức bằng cách nhập hàm số vào ô lệnh (H.T.2).",
    "[Hình ảnh: Hình T.2. Đồ thị hàm phân thức $y = \\frac{2x^2 - x + 1}{2x - 2}$ và các tiệm cận được vẽ trên GeoGebra.]",
    "*Hình T.2*",
    "",
    ...
    "- *Bước 2.* Vẽ đồ thị hàm số bằng cách nhập hàm số vào ô lệnh (H.T.3).",
    "[Hình ảnh: Hình T.3. Đồ thị hàm phân thức $y = \\frac{x^2 + x + 1}{3 - 2x - x^2}$ và các đường tiệm cận trên GeoGebra.]",
    "*Hình T.3*",
    "",
    "90",
    ...
    "",
    "**Hoạt động:** Lấy bốn điểm $A, B, C, D$ trong không gian ba chiều và vẽ vectơ $\\vec{u} = \\vec{AB} + \\vec{AC} + \\vec{AD}$.",
    "**Hướng dẫn thực hiện:**",
    ...
    "[Hình ảnh: Hình T.4. Giao diện mở Phối cảnh\\Vẽ đồ hoạ 3D trong GeoGebra.]",
    "[Hình ảnh: Hình T.5. Tuỳ chọn Hiển thị hệ trục toạ độ, lưới và mặt phẳng.]",
    "",
    ...
    "[Hình ảnh: Minh hoạ điểm A với các mũi tên di chuyển.]",
    "[Hình ảnh: Hình T.6. Công cụ Điểm mới trên thanh công cụ GeoGebra.]",
    "",
    "- *Bước 3.* Sử dụng công cụ vẽ vectơ qua 2 điểm (H.T.7) để vẽ ba vectơ $\\vec{AB}, \\vec{AC}, \\vec{AD}$.",
    "[Hình ảnh: Hình T.7. Tuỳ chọn Vectơ qua 2 điểm.]",
    "",
    "- *Bước 4.* Sử dụng công cụ \"Đường song song\" (H.T.8) để vẽ các đường thẳng song song với các vectơ $\\vec{AB}, \\vec{AC}$.",
    "[Hình ảnh: Hình T.8. Tuỳ chọn Đường song song trên GeoGebra.]",
    "",
    "92",
    "Xác định giao điểm $E$ của hai đường thẳng đó bằng công cụ \"Giao điểm của 2 đối tượng\".",
    "Vẽ vectơ $\\vec{AE}$.",
    "Theo nguyên tắc hình bình hành, ta có: $\\vec{AE} = \\vec{AB} + \\vec{AC}$.",
    "[Hình ảnh: Hình T.9. Vẽ vectơ AE bằng quy tắc hình bình hành.]",
    "*Hình T.9*",
    "",
    "- *Bước 5.* Sử dụng công cụ vẽ đường thẳng song song để vẽ các đường thẳng song song với các vectơ $\\vec{AD}, \\vec{AE}$ và xác định giao điểm $F$ của hai đường thẳng đó.",
    "[Hình ảnh: Hình T.10. Xác định điểm F bằng cách vẽ các đường thẳng song song qua D và E.]",
    "*Hình T.10*",
    "",
    "- *Bước 6.* Vẽ vectơ $\\vec{AF}$.",
    "Theo nguyên tắc hình bình hành, ta có: $\\vec{AF} = \\vec{AE} + \\vec{AD} = \\vec{AB} + \\vec{AC} + \\vec{AD}$.",
    "Vậy $\\vec{AF}$ chính là vectơ $\\vec{u}$ cần dựng.",
    "[Hình ảnh: Hình T.11. Vectơ AF dựng được chính là tổng của 3 vectơ.]",
    "*Hình T.11*",
    "",
    "93",
    "# ĐỘ DÀI GANG TAY",
    "# (GANG TAY CỦA BẠN DÀI BAO NHIÊU?)",
    "",
    "**MỤC TIÊU**",
    "Thực hiện thu thập và phân tích dữ liệu để so sánh độ dài gang tay của hai nhóm học sinh nam và học sinh nữ trong lớp học.",
    "",
    "Độ dài gang tay là một số đo của cơ thể. Các nhà sản xuất găng tay căn cứ vào đó để sản xuất các sản phẩm với kích thước khác nhau dùng trong y tế, thể thao, lao động,... Liệu chiều dài gang tay của nam giới có khác biệt so với nữ giới? Phân bố của chiều dài gang tay như thế nào?",
    "Trong bài này, chúng ta sẽ thực hiện một phân tích nhỏ trong phạm vi lớp học để so sánh chiều dài gang tay của các bạn nam và các bạn nữ. Ta sẽ thu thập dữ liệu trên hai nhóm và so sánh thông qua tính toán những số đo thống kê mô tả đã học.",
    "[Hình ảnh: Các găng tay nhiều màu sắc (hồng, xanh lá, vàng).]",
    "",
    "## 1. THU THẬP DỮ LIỆU",
    "**Chuẩn bị:**",
    "- Thước kẻ có vạch chia centimét;",
    "- Bút, giấy.",
    "**Thực hiện:**",
    "a) Cách đo độ dài gang tay như sau:",
    "- Đặt thước trên bàn;",
    "- Đưa ngón tay cái và ngón tay út của bàn tay phải lên phía trên thước;",
    "- Đặt ngón cái tại điểm đánh dấu 0 cm;",
    "- Dãn ngón út tối đa và xác định vị trí của đầu ngón út trên thước.",
    "[Hình ảnh: Minh hoạ bàn tay đặt trên thước đo.]",
    "",
    "b) Thu thập dữ liệu theo mẫu phiếu sau:",
    "[Bảng ảnh: Khảo sát về độ dài gang tay. Giới tính: Nữ / Nam. Độ dài gang tay (đơn vị: cm) thuộc phạm vi nào sau đây: [16; 17), [17; 18), [18; 19), [19; 20), [20; 21), [21; 22), [22; 23), [23; 24)]",
    "[Hình ảnh: Cậu bé gợi ý: Phiếu khảo sát có thể tạo trên Google biểu mẫu (Google form).]",
    "",
    "94"
  ]
}
...
INSERT INTO lessons (chapter_id, code, name, page, sort_order, knowledge_json) VALUES
((SELECT id FROM chapters WHERE code = 'CH4' AND textbook_id = (SELECT id FROM textbooks WHERE code = 'TOAN12_T1')), 'B13', 'Vẽ vectơ tổng của ba vectơ trong không gian bằng phần mềm GeoGebra', 92, 2, $JSON$
{
  "content": [
    "**HĐ1.** Lưu dữ liệu thu được vào bảng theo mẫu sau:",
    ...
    "| [22; 23) | | \\ |",
    "| [23; 24) | | |",
    "*Bảng T.1. Kết quả đo gang tay của hai nhóm học sinh nữ và nam*",
    "",
    "## 2. TÓM TẮT VÀ PHÂN TÍCH DỮ LIỆU",
    "**HĐ2.** Lập bảng tần số ghép nhóm cho dữ liệu thu được trên từng nhóm theo mẫu sau đây và minh hoạ bằng biểu đồ tần số.",
    "| Chiều dài gang tay (cm) | [16; 17) | [17; 18) | [18; 19) | [19; 20) | [20; 21) | [21; 22) | [22; 23) | [23; 24) |",
    "| :--- | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: |",
    "| Số học sinh nam | ? | ? | ? | ? | ? | ? | ? | ? |",
    "| Số học sinh nữ | ? | ? | ? | ? | ? | ? | ? | ? |",
    "",
    "**HĐ3.** Sử dụng bảng tần số thu được ở HĐ2, em hãy:",
    "a) Tính độ dài gang tay trung bình của các học sinh nữ, học sinh nam trong lớp và so sánh.",
    "b) Tính phương sai, độ lệch chuẩn và từ đó tính hệ số biến thiên của độ dài gang tay của hai nhóm học sinh và so sánh.",
    "",
    "**HĐ4.** Bảng tần số sau đây là dữ liệu thu được trên một lớp học. Hãy thực hiện HĐ3 cho mẫu số liệu này.",
    ...
    "",
    "95",
    "**HĐ5. Góc công nghệ thông tin**",
    "Việc tính số trung bình, phương sai, độ lệch chuẩn của mẫu số liệu được cho trong bảng tần số ghép nhóm có thể thực hiện trên phần mềm bảng tính Excel. Sau đây là minh hoạ việc tính trên mẫu số liệu thu được của học sinh nữ trong bảng cho trong HĐ4.",
    "- *Bước 1.* Nhập các đầu mút trái, các đầu mút phải, tần số của các nhóm tương ứng vào các cột. Sau đó xác định điểm đại diện của từng nhóm (H.T.12).",
    "[Hình ảnh: Hình T.12. Nhập các đầu mút trái, đầu mút phải, tần số và tính điểm đại diện bằng công thức Excel =AVERAGE(B2:C2).]",
    "",
    "- *Bước 2.* Nhân tần số với điểm đại diện của từng nhóm và tính tổng bằng cách dùng hàm SUM (H.T.13).",
    "[Hình ảnh: Hình T.13. Nhân tần số với điểm đại diện (=D2*E2) và tính tổng bằng hàm SUM.]",
    "",
    "96",
    "- *Bước 3.* Tính tổng các tần số và thực hiện tính số trung bình. Kết quả thu được số trung bình bằng 18,71 (H.T.14).",
    "[Hình ảnh: Hình T.14. Tính tổng tần số và tính số trung bình bằng công thức =F8/D8.]",
    "",
    "- *Bước 4.* Để tính phương sai, độ lệch chuẩn, ta lần lượt lấy các điểm đại diện trừ đi số trung bình và bình phương kết quả (H.T.15).",
    "[Hình ảnh: Hình T.15. Tính bình phương độ lệch của điểm đại diện so với số trung bình bằng công thức =(E2-$C$10)^2.]",
    "",
    "97",
    "- *Bước 5.* Lần lượt lấy tần số nhân với các bình phương vừa tạo ra ở Bước 4, rồi lấy tổng các kết quả thu được (H.T.16).",
    "[Hình ảnh: Hình T.16. Nhân tần số với bình phương độ lệch (=D2*G2) và tính tổng bằng hàm SUM.]",
    "",
    "- *Bước 6.* Tính phương sai, độ lệch chuẩn (H.T.17).",
    "[Hình ảnh: Hình T.17. Tính phương sai bằng công thức =H8/D8 và độ lệch chuẩn bằng công thức =SQRT(C11).]",
    "",
    "Kết quả thu được, phương sai của mẫu số liệu là 1,10 và độ lệch chuẩn là 1,05.",
    "",
    "---",
    "**Em có biết?**",
    "Vào những năm 1990, Christopher Donison và David Steinbuhler đã lần đầu tiên giới thiệu loại bàn phím piano 7/8 và 15/16 giúp những người có độ dài gang tay nhỏ có trải nghiệm chơi đàn piano tốt hơn. Hai loại bàn phím này có độ dài mỗi quãng tám là 5,5 và 6,0 (inches) tương ứng (nhỏ hơn so với 6,5 inches của những chiếc đàn phổ biến lúc đó) và chúng được kí hiệu là DS5.5 và DS6.0. Ngoài ra họ còn giới thiệu bàn phím DS5.1 dành cho trẻ em. Việc này đã tạo ra tiêu chuẩn mới cho việc sản xuất bàn phím piano hiện đại.",
    "*(Theo dsstandardfoundation.org)*",
    "[Hình ảnh: Đôi bàn tay đang chơi trên bàn phím piano.]",
    "",
    "98",
    "# BẢNG TRA CỨU TỪ NGỮ",
    "",
    ...
    "",
    "**K**",
    "- Khảo sát sự biến thiên của hàm số 26",
    ...
    "| Điểm cực trị của đồ thị hàm số | Điểm $(x_0; f(x_0))$, trong đó $x_0$ là điểm cực trị của hàm số $f(x)$ |",
    "| Điểm cực trị của hàm số | Điểm cực trị của hàm số là giá trị của biến số mà tại đó hàm số đạt cực trị |",
    "| Giá trị lớn nhất của hàm số | Số $M$ được gọi là giá trị lớn nhất của hàm số $y = f(x)$ trên tập $D$ nếu $f(x) \\le M$ với mọi $x \\in D$ và tồn tại $x_0 \\in D$ sao cho $f(x_0) = M$ |",
    "| Giá trị nhỏ nhất của hàm số | Số $m$ được gọi là giá trị nhỏ nhất của hàm số $y = f(x)$ trên tập $D$ nếu $f(x) \\ge m$ với mọi $x \\in D$ và tồn tại $x_0 \\in D$ sao cho $f(x_0) = m$ |",
    "| Góc giữa hai vectơ trong không gian | Góc $\\widehat{AOB}$, trong đó $\\vec{OA}$ và $\\vec{OB}$ là hai vectơ chung gốc và lần lượt bằng hai vectơ khác $\\vec{0}$ đã cho |",
    "| Hệ toạ độ trong không gian | Hệ gồm ba trục vuông góc với nhau từng đôi một với ba vectơ đơn vị trên ba trục |",
    ...
    "| Tiệm cận đứng | Đường thẳng $x = x_0$ gọi là tiệm cận đứng của đồ thị hàm số $y = f(x)$ nếu một trong các điều kiện sau được thoả mãn:<br>$\\lim_{x \\to x_0^+} f(x) = +\\infty$; $\\lim_{x \\to x_0^+} f(x) = -\\infty$; $\\lim_{x \\to x_0^-} f(x) = -\\infty$; $\\lim_{x \\to x_0^-} f(x) = +\\infty$ |",
    "| Tiệm cận ngang | Đường thẳng $y = y_0$ gọi là tiệm cận ngang của đồ thị hàm số $y = f(x)$ nếu $\\lim_{x \\to +\\infty} f(x) = y_0$ hoặc $\\lim_{x \\to -\\infty} f(x) = y_0$ |",
    "| Tiệm cận xiên | Đường thẳng $y = ax + b$ ($a \\neq 0$) gọi là tiệm cận xiên của đồ thị hàm số $y = f(x)$ nếu<br>$\\lim_{x \\to +\\infty} [f(x) - (ax + b)] = 0$ hoặc $\\lim_{x \\to -\\infty} [f(x) - (ax + b)] = 0$ |",
    ...
    "Thiết kế sách: NGUYỄN BÁ HÀN",
    "Trình bày bìa: NGUYỄN BÍCH LA",
    "Minh hoạ: BÙI VIỆT DUY",
    "Sửa bản in: VŨ THỊ THANH TÂM – TẠ THỊ HƯỜNG",
...
INSERT INTO lessons (chapter_id, code, name, page, sort_order, knowledge_json) VALUES
((SELECT id FROM chapters WHERE code = 'CH4' AND textbook_id = (SELECT id FROM textbooks WHERE code = 'TOAN12_T1')), 'B14', 'Độ dài gang tay (gang tay của bạn dài bao nhiêu?)', 94, 3, $JSON$
{
  "content": [
    ...
    "- **Miền Bắc**: CTCP Đầu tư và Phát triển Giáo dục Hà Nội, CTCP Sách và Thiết bị Giáo dục miền Bắc",
    "- **Miền Trung**: CTCP Đầu tư và Phát triển Giáo dục Đà Nẵng, CTCP Sách và Thiết bị Giáo dục miền Trung",
    "- **Miền Nam**: CTCP Đầu tư và Phát triển Giáo dục Phương Nam, CTCP Sách và Thiết bị Giáo dục miền Nam, CTCP Sách và Thiết bị Giáo dục Cửu Long",
...
INSERT INTO lessons (chapter_id, code, name, page, sort_order, knowledge_json) VALUES
((SELECT id FROM chapters WHERE code = 'END' AND textbook_id = (SELECT id FROM textbooks WHERE code = 'TOAN12_T1')), 'END_1', 'Thông tin cuối sách', 99, 1, $JSON$
{
  "content": [
    ...
    "",
    "LÊ MẬU HẢI (Chủ tịch), CAO THỊ HÀ (Phó Chủ tịch)",
    "PHẠM ĐỨC TÀI (Uỷ viên, Thư kí), PHẠM KHẮC BAN – NGUYỄN HẮC HẢI",
    "NGUYỄN DOÃN PHÚ – NGUYỄN CHIẾN THẮNG – NGUYỄN THỊ VĨNH THUYÊN",
    "ĐINH CAO THƯỢNG – PHẠM ĐÌNH TÙNG – VŨ THỊ NHƯ TRANG (Uỷ viên)",
    "",
