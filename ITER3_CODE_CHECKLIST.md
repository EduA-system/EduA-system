...
| [x] | Moderator Account Management | User & Content Management | Pending | Coded | Backend `/api/admin/moderators` (`AdminController.java`); frontend `/user-management`. Role contract hiện là `PRINCIPAL`. |
...
| [x] | View / Update AI System Prompts | User & Content Management | Pending | Coded | Backend `/api/it-management/system-prompts` (`ItManagementController.java`); frontend `/it-management`; prompt được apply vào lesson/slide/molecule AI flows. Role contract hiện là `IT_STAFF`. |
...
- Account management API: `be/src/main/java/com/edua/beeduasystem/presentation/controller/AdminController.java`, `be/src/main/java/com/edua/beeduasystem/presentation/controller/ModeratorController.java`
- Account management UI: `fe/app/user-management/page.tsx`
- IT Staff prompt management API/UI: `be/src/main/java/com/edua/beeduasystem/presentation/controller/ItManagementController.java`, `fe/app/it-management/page.tsx`
